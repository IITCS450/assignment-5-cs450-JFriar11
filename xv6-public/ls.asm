...
00000060 <fmtname>:
{
  ...
  return buf;
  c5:	bb a0 11 00 00       	mov    $0x11a0,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ...
  db:	05 a0 11 00 00       	add    $0x11a0,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
 ...
 628:	89 d1                	mov    %edx,%ecx
{
 ...
 65b:	0f b6 92 40 0d 00 00 	movzbl 0xd40(%edx),%edx
 ...
 6c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 734:	ff 24 85 e8 0c 00 00 	jmp    *0xce8(,%eax,4)
 ...
 840:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 845:	bb de 0c 00 00       	mov    $0xcde,%ebx
...
free(void *ap)
{
 ...
 851:	a1 b0 11 00 00       	mov    0x11b0,%eax
{
 ...
 88f:	5b                   	pop    %ebx
  freep = p;
 890:	a3 b0 11 00 00       	mov    %eax,0x11b0
}
 895:	5e                   	pop    %esi
 896:	5f                   	pop    %edi
 897:	5d                   	pop    %ebp
 ...
 8a6:	72 ce                	jb     876 <free+0x26>
{
 ...
 8c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 8ca:	a3 b0 11 00 00       	mov    %eax,0x11b0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8ec:	8b 15 b0 11 00 00    	mov    0x11b0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 92b:	3b 05 b0 11 00 00    	cmp    0x11b0,%eax
 ...
 94e:	e8 fd fe ff ff       	call   850 <free>
  return freep;
 953:	8b 15 b0 11 00 00    	mov    0x11b0,%edx
 ...
 97c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 97f:	89 15 b0 11 00 00    	mov    %edx,0x11b0
}
 ...
 98f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 990:	c7 05 b0 11 00 00 b4 	movl   $0x11b4,0x11b0
 997:	11 00 00 
    base.s.size = 0;
 99a:	b8 b4 11 00 00       	mov    $0x11b4,%eax
    base.s.ptr = freep = prevp = &base;
 99f:	c7 05 b4 11 00 00 b4 	movl   $0x11b4,0x11b4
 9a6:	11 00 00 
    base.s.size = 0;
 9a9:	c7 05 b8 11 00 00 00 	movl   $0x0,0x11b8
 9b0:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void)
{
 ...
 9d0:	a1 c0 11 00 00       	mov    0x11c0,%eax
        table[i].state = TS_FREE;
 9d5:	c7 05 f0 21 00 00 00 	movl   $0x0,0x21f0
 9dc:	00 00 00 
 9df:	c7 05 fc 31 00 00 00 	movl   $0x0,0x31fc
 9e6:	00 00 00 
    table[0].tid   = next_tid++;
 9e9:	8d 50 01             	lea    0x1(%eax),%edx
        table[i].state = TS_FREE;
 9ec:	c7 05 08 42 00 00 00 	movl   $0x0,0x4208
 9f3:	00 00 00 
 9f6:	c7 05 14 52 00 00 00 	movl   $0x0,0x5214
 9fd:	00 00 00 
 a00:	c7 05 20 62 00 00 00 	movl   $0x0,0x6220
 a07:	00 00 00 
 a0a:	c7 05 2c 72 00 00 00 	movl   $0x0,0x722c
 a11:	00 00 00 
 a14:	c7 05 38 82 00 00 00 	movl   $0x0,0x8238
 a1b:	00 00 00 
    table[0].tid   = next_tid++;
 a1e:	89 15 c0 11 00 00    	mov    %edx,0x11c0
 a24:	a3 e0 11 00 00       	mov    %eax,0x11e0
    table[0].state = TS_RUNNING;
 a29:	c7 05 e4 11 00 00 02 	movl   $0x2,0x11e4
 a30:	00 00 00 
    cur = 0;
 a33:	c7 05 c4 11 00 00 00 	movl   $0x0,0x11c4
 a3a:	00 00 00 
}
 a3d:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg)
{
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 a40:	ba e4 11 00 00       	mov    $0x11e4,%edx
 ...
 a54:	74 1a                	je     a70 <thread_create+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 a56:	83 c0 01             	add    $0x1,%eax
 a59:	81 c2 0c 10 00 00    	add    $0x100c,%edx
 a5f:	83 f8 08             	cmp    $0x8,%eax
 a62:	75 ec                	jne    a50 <thread_create+0x10>
 ...
 a64:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 a69:	c3                   	ret
 a6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
 a70:	55                   	push   %ebp
    uint *sp = (uint*)(table[i].stack + STACK_SIZE);
 a71:	69 c0 0c 10 00 00    	imul   $0x100c,%eax,%eax
{
 a77:	89 e5                	mov    %esp,%ebp
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 a79:	8d 90 cc 21 00 00    	lea    0x21cc(%eax),%edx
{
 a7f:	53                   	push   %ebx
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 a80:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 a83:	89 90 e8 11 00 00    	mov    %edx,0x11e8(%eax)
    table[i].tid       = next_tid++;
 a89:	8b 15 c0 11 00 00    	mov    0x11c0,%edx
    *(--sp) = 0xffffffff;        /* fake return address    */
 a8f:	c7 80 e0 21 00 00 ff 	movl   $0xffffffff,0x21e0(%eax)
 a96:	ff ff ff 
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 a99:	89 88 e8 21 00 00    	mov    %ecx,0x21e8(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 a9f:	8b 4d 08             	mov    0x8(%ebp),%ecx
    table[i].tid       = next_tid++;
 aa2:	8d 5a 01             	lea    0x1(%edx),%ebx
 aa5:	89 90 e0 11 00 00    	mov    %edx,0x11e0(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 aab:	89 88 e4 21 00 00    	mov    %ecx,0x21e4(%eax)
    *(--sp) = (uint)thread_stub; /* eip: ret jumps here    */
 ab1:	c7 80 dc 21 00 00 90 	movl   $0xb90,0x21dc(%eax)
 ab8:	0b 00 00 
    *(--sp) = 0;                 /* ebp                    */
 abb:	c7 80 d8 21 00 00 00 	movl   $0x0,0x21d8(%eax)
 ac2:	00 00 00 
    *(--sp) = 0;                 /* ebx                    */
 ac5:	c7 80 d4 21 00 00 00 	movl   $0x0,0x21d4(%eax)
 acc:	00 00 00 
    *(--sp) = 0;                 /* esi                    */
 acf:	c7 80 d0 21 00 00 00 	movl   $0x0,0x21d0(%eax)
 ad6:	00 00 00 
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 ad9:	c7 80 cc 21 00 00 00 	movl   $0x0,0x21cc(%eax)
 ae0:	00 00 00 
    table[i].tid       = next_tid++;
 ae3:	89 1d c0 11 00 00    	mov    %ebx,0x11c0
}
 ae9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    table[i].state     = TS_RUNNABLE;
 aec:	c7 80 e4 11 00 00 01 	movl   $0x1,0x11e4(%eax)
 af3:	00 00 00 
}
...
void thread_yield(void)
{
 ...
 b06:	83 ec 0c             	sub    $0xc,%esp
    int old  = cur;
 b09:	8b 1d c4 11 00 00    	mov    0x11c4,%ebx
    for(i = 1; i <= MAX_THREADS; i++){
 b0f:	8d 53 01             	lea    0x1(%ebx),%edx
 b12:	8d 73 09             	lea    0x9(%ebx),%esi
 b15:	8d 76 00             	lea    0x0(%esi),%esi
        int idx = (cur + i) % MAX_THREADS;
 b18:	89 d1                	mov    %edx,%ecx
 b1a:	c1 f9 1f             	sar    $0x1f,%ecx
 b1d:	c1 e9 1d             	shr    $0x1d,%ecx
 b20:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
 b23:	83 e0 07             	and    $0x7,%eax
 b26:	29 c8                	sub    %ecx,%eax
        if(table[idx].state == TS_RUNNABLE)
 b28:	69 c8 0c 10 00 00    	imul   $0x100c,%eax,%ecx
 b2e:	83 b9 e4 11 00 00 01 	cmpl   $0x1,0x11e4(%ecx)
 b35:	8d b9 e0 11 00 00    	lea    0x11e0(%ecx),%edi
 b3b:	74 13                	je     b50 <thread_yield+0x50>
    for(i = 1; i <= MAX_THREADS; i++){
 b3d:	83 c2 01             	add    $0x1,%edx
 b40:	39 f2                	cmp    %esi,%edx
 b42:	75 d4                	jne    b18 <thread_yield+0x18>
 ...
 b4c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(next == -1) return;
 b50:	83 f8 ff             	cmp    $0xffffffff,%eax
 b53:	74 ef                	je     b44 <thread_yield+0x44>
    table[old].state  = TS_RUNNABLE;
 b55:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 b5b:	83 ec 08             	sub    $0x8,%esp
    cur = next;
 b5e:	a3 c4 11 00 00       	mov    %eax,0x11c4
    table[old].state  = TS_RUNNABLE;
 b63:	c7 83 e4 11 00 00 01 	movl   $0x1,0x11e4(%ebx)
 b6a:	00 00 00 
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 b6d:	81 c3 e8 11 00 00    	add    $0x11e8,%ebx
    table[next].state = TS_RUNNING;
 b73:	c7 47 04 02 00 00 00 	movl   $0x2,0x4(%edi)
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 b7a:	ff 77 08             	push   0x8(%edi)
 b7d:	53                   	push   %ebx
 b7e:	e8 fb 00 00 00       	call   c7e <uswtch>
 b83:	83 c4 10             	add    $0x10,%esp
}
 b86:	8d 65 f4             	lea    -0xc(%ebp),%esp
 b89:	5b                   	pop    %ebx
 b8a:	5e                   	pop    %esi
 b8b:	5f                   	pop    %edi
 b8c:	5d                   	pop    %ebp
...
00000b90 <thread_stub>:
{
 b90:	55                   	push   %ebp
 b91:	89 e5                	mov    %esp,%ebp
 b93:	83 ec 14             	sub    $0x14,%esp
    fn(arg);
 b96:	ff 75 0c             	push   0xc(%ebp)
 b99:	ff 55 08             	call   *0x8(%ebp)
    table[cur].state = TS_ZOMBIE;
 b9c:	69 05 c4 11 00 00 0c 	imul   $0x100c,0x11c4,%eax
 ba3:	10 00 00 
 ba6:	83 c4 10             	add    $0x10,%esp
 ba9:	c7 80 e4 11 00 00 03 	movl   $0x3,0x11e4(%eax)
 bb0:	00 00 00 
 bb3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        thread_yield();
 bb8:	e8 43 ff ff ff       	call   b00 <thread_yield>
    while(1)
 bbd:	eb f9                	jmp    bb8 <thread_stub+0x28>
 bbf:	90                   	nop
...
{
 bc0:	55                   	push   %ebp
 bc1:	b8 e0 11 00 00       	mov    $0x11e0,%eax
 ...
 bcc:	53                   	push   %ebx
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 bcd:	31 db                	xor    %ebx,%ebx
 bcf:	90                   	nop
        if(table[i].tid == tid) break;
 bd0:	39 10                	cmp    %edx,(%eax)
 bd2:	74 1c                	je     bf0 <thread_join+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 bd4:	83 c3 01             	add    $0x1,%ebx
 bd7:	05 0c 10 00 00       	add    $0x100c,%eax
 bdc:	83 fb 08             	cmp    $0x8,%ebx
 bdf:	75 ef                	jne    bd0 <thread_join+0x10>
 ...
 bea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(table[i].state != TS_ZOMBIE)
 bf0:	69 c3 0c 10 00 00    	imul   $0x100c,%ebx,%eax
 bf6:	83 b8 e4 11 00 00 03 	cmpl   $0x3,0x11e4(%eax)
 bfd:	8d b0 e0 11 00 00    	lea    0x11e0(%eax),%esi
 c03:	74 0e                	je     c13 <thread_join+0x53>
 c05:	8d 76 00             	lea    0x0(%esi),%esi
        thread_yield();
 c08:	e8 f3 fe ff ff       	call   b00 <thread_yield>
    while(table[i].state != TS_ZOMBIE)
 c0d:	83 7e 04 03          	cmpl   $0x3,0x4(%esi)
 c11:	75 f5                	jne    c08 <thread_join+0x48>
    table[i].state = TS_FREE;
 c13:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    return 0;
 c19:	31 c0                	xor    %eax,%eax
    table[i].state = TS_FREE;
 c1b:	c7 83 e4 11 00 00 00 	movl   $0x0,0x11e4(%ebx)
 c22:	00 00 00 
 c25:	5b                   	pop    %ebx
 c26:	5e                   	pop    %esi
 c27:	5d                   	pop    %ebp
...
void mutex_lock(umutex_t *m)   { while (m->locked) thread_yield(); m->locked = 1; }
 ...
 c4e:	74 0b                	je     c5b <mutex_lock+0x1b>
 c50:	e8 ab fe ff ff       	call   b00 <thread_yield>
 c55:	8b 03                	mov    (%ebx),%eax
 c57:	85 c0                	test   %eax,%eax
 c59:	75 f5                	jne    c50 <mutex_lock+0x10>
 c5b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
...
uswtch:
 ...
 c81:	57                   	push   %edi
    ...
    movl  20(%esp), %eax
 c82:	8b 44 24 14          	mov    0x14(%esp),%eax
    movl  %esp, (%eax)
 c86:	89 20                	mov    %esp,(%eax)

    movl  24(%esp), %esp
 c88:	8b 64 24 18          	mov    0x18(%esp),%esp
