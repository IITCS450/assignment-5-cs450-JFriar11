...
main(int argc, char *argv[])
{
  ...
  30:	68 d4 09 00 00       	push   $0x9d4
  35:	83 c3 01             	add    $0x1,%ebx
  38:	50                   	push   %eax
  39:	68 d6 09 00 00       	push   $0x9d6
  3e:	6a 01                	push   $0x1
  ...
  50:	68 db 09 00 00       	push   $0x9db
  55:	50                   	push   %eax
  56:	68 d6 09 00 00       	push   $0x9d6
  5b:	6a 01                	push   $0x1
 ...
 368:	89 d1                	mov    %edx,%ecx
{
 ...
 39b:	0f b6 92 3c 0a 00 00 	movzbl 0xa3c(%edx),%edx
 ...
 409:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 474:	ff 24 85 e4 09 00 00 	jmp    *0x9e4(,%eax,4)
 ...
 580:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 585:	bb dd 09 00 00       	mov    $0x9dd,%ebx
...
free(void *ap)
{
 ...
 591:	a1 20 0e 00 00       	mov    0xe20,%eax
{
 ...
 5cf:	5b                   	pop    %ebx
  freep = p;
 5d0:	a3 20 0e 00 00       	mov    %eax,0xe20
}
 5d5:	5e                   	pop    %esi
 5d6:	5f                   	pop    %edi
 5d7:	5d                   	pop    %ebp
 ...
 5e6:	72 ce                	jb     5b6 <free+0x26>
{
 ...
 607:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60a:	a3 20 0e 00 00       	mov    %eax,0xe20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 20 0e 00 00    	mov    0xe20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 66b:	3b 05 20 0e 00 00    	cmp    0xe20,%eax
 ...
 68e:	e8 fd fe ff ff       	call   590 <free>
  return freep;
 693:	8b 15 20 0e 00 00    	mov    0xe20,%edx
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6bf:	89 15 20 0e 00 00    	mov    %edx,0xe20
}
 ...
 6cf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6d0:	c7 05 20 0e 00 00 24 	movl   $0xe24,0xe20
 6d7:	0e 00 00 
    base.s.size = 0;
 6da:	b8 24 0e 00 00       	mov    $0xe24,%eax
    base.s.ptr = freep = prevp = &base;
 6df:	c7 05 24 0e 00 00 24 	movl   $0xe24,0xe24
 6e6:	0e 00 00 
    base.s.size = 0;
 6e9:	c7 05 28 0e 00 00 00 	movl   $0x0,0xe28
 6f0:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void)
{
 ...
 710:	a1 40 0e 00 00       	mov    0xe40,%eax
        table[i].state = TS_FREE;
 715:	c7 05 70 1e 00 00 00 	movl   $0x0,0x1e70
 71c:	00 00 00 
 71f:	c7 05 7c 2e 00 00 00 	movl   $0x0,0x2e7c
 726:	00 00 00 
    table[0].tid   = next_tid++;
 729:	8d 50 01             	lea    0x1(%eax),%edx
        table[i].state = TS_FREE;
 72c:	c7 05 88 3e 00 00 00 	movl   $0x0,0x3e88
 733:	00 00 00 
 736:	c7 05 94 4e 00 00 00 	movl   $0x0,0x4e94
 73d:	00 00 00 
 740:	c7 05 a0 5e 00 00 00 	movl   $0x0,0x5ea0
 747:	00 00 00 
 74a:	c7 05 ac 6e 00 00 00 	movl   $0x0,0x6eac
 751:	00 00 00 
 754:	c7 05 b8 7e 00 00 00 	movl   $0x0,0x7eb8
 75b:	00 00 00 
    table[0].tid   = next_tid++;
 75e:	89 15 40 0e 00 00    	mov    %edx,0xe40
 764:	a3 60 0e 00 00       	mov    %eax,0xe60
    table[0].state = TS_RUNNING;
 769:	c7 05 64 0e 00 00 02 	movl   $0x2,0xe64
 770:	00 00 00 
    cur = 0;
 773:	c7 05 44 0e 00 00 00 	movl   $0x0,0xe44
 77a:	00 00 00 
}
 77d:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg)
{
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 780:	ba 64 0e 00 00       	mov    $0xe64,%edx
 ...
 792:	85 c9                	test   %ecx,%ecx
 794:	74 1a                	je     7b0 <thread_create+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 796:	83 c0 01             	add    $0x1,%eax
 799:	81 c2 0c 10 00 00    	add    $0x100c,%edx
 79f:	83 f8 08             	cmp    $0x8,%eax
 7a2:	75 ec                	jne    790 <thread_create+0x10>
 ...
 7aa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
 ...
 7b1:	69 c0 0c 10 00 00    	imul   $0x100c,%eax,%eax
{
 7b7:	89 e5                	mov    %esp,%ebp
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 7b9:	8d 90 4c 1e 00 00    	lea    0x1e4c(%eax),%edx
{
 7bf:	53                   	push   %ebx
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 7c0:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 7c3:	89 90 68 0e 00 00    	mov    %edx,0xe68(%eax)
    table[i].tid       = next_tid++;
 7c9:	8b 15 40 0e 00 00    	mov    0xe40,%edx
    *(--sp) = 0xffffffff;        /* fake return address    */
 7cf:	c7 80 60 1e 00 00 ff 	movl   $0xffffffff,0x1e60(%eax)
 7d6:	ff ff ff 
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 7d9:	89 88 68 1e 00 00    	mov    %ecx,0x1e68(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 7df:	8b 4d 08             	mov    0x8(%ebp),%ecx
    table[i].tid       = next_tid++;
 7e2:	8d 5a 01             	lea    0x1(%edx),%ebx
 7e5:	89 90 60 0e 00 00    	mov    %edx,0xe60(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 7eb:	89 88 64 1e 00 00    	mov    %ecx,0x1e64(%eax)
    *(--sp) = (uint)thread_stub; /* eip: ret jumps here    */
 7f1:	c7 80 5c 1e 00 00 d0 	movl   $0x8d0,0x1e5c(%eax)
 7f8:	08 00 00 
    *(--sp) = 0;                 /* ebp                    */
 7fb:	c7 80 58 1e 00 00 00 	movl   $0x0,0x1e58(%eax)
 802:	00 00 00 
    *(--sp) = 0;                 /* ebx                    */
 805:	c7 80 54 1e 00 00 00 	movl   $0x0,0x1e54(%eax)
 80c:	00 00 00 
    *(--sp) = 0;                 /* esi                    */
 80f:	c7 80 50 1e 00 00 00 	movl   $0x0,0x1e50(%eax)
 816:	00 00 00 
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 819:	c7 80 4c 1e 00 00 00 	movl   $0x0,0x1e4c(%eax)
 820:	00 00 00 
    table[i].tid       = next_tid++;
 823:	89 1d 40 0e 00 00    	mov    %ebx,0xe40
}
 829:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    table[i].state     = TS_RUNNABLE;
 82c:	c7 80 64 0e 00 00 01 	movl   $0x1,0xe64(%eax)
 833:	00 00 00 
}
...
void thread_yield(void)
{
 ...
 846:	83 ec 0c             	sub    $0xc,%esp
    int old  = cur;
 849:	8b 1d 44 0e 00 00    	mov    0xe44,%ebx
    for(i = 1; i <= MAX_THREADS; i++){
 84f:	8d 53 01             	lea    0x1(%ebx),%edx
 852:	8d 73 09             	lea    0x9(%ebx),%esi
 855:	8d 76 00             	lea    0x0(%esi),%esi
        int idx = (cur + i) % MAX_THREADS;
 858:	89 d1                	mov    %edx,%ecx
 85a:	c1 f9 1f             	sar    $0x1f,%ecx
 85d:	c1 e9 1d             	shr    $0x1d,%ecx
 860:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
 863:	83 e0 07             	and    $0x7,%eax
 866:	29 c8                	sub    %ecx,%eax
        if(table[idx].state == TS_RUNNABLE)
 868:	69 c8 0c 10 00 00    	imul   $0x100c,%eax,%ecx
 86e:	83 b9 64 0e 00 00 01 	cmpl   $0x1,0xe64(%ecx)
 875:	8d b9 60 0e 00 00    	lea    0xe60(%ecx),%edi
 87b:	74 13                	je     890 <thread_yield+0x50>
    for(i = 1; i <= MAX_THREADS; i++){
 87d:	83 c2 01             	add    $0x1,%edx
 880:	39 f2                	cmp    %esi,%edx
 882:	75 d4                	jne    858 <thread_yield+0x18>
 ...
 893:	74 ef                	je     884 <thread_yield+0x44>
    table[old].state  = TS_RUNNABLE;
 895:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 89b:	83 ec 08             	sub    $0x8,%esp
    cur = next;
 89e:	a3 44 0e 00 00       	mov    %eax,0xe44
    table[old].state  = TS_RUNNABLE;
 8a3:	c7 83 64 0e 00 00 01 	movl   $0x1,0xe64(%ebx)
 8aa:	00 00 00 
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 8ad:	81 c3 68 0e 00 00    	add    $0xe68,%ebx
    table[next].state = TS_RUNNING;
 8b3:	c7 47 04 02 00 00 00 	movl   $0x2,0x4(%edi)
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 8ba:	ff 77 08             	push   0x8(%edi)
 8bd:	53                   	push   %ebx
 8be:	e8 fb 00 00 00       	call   9be <uswtch>
...
000008d0 <thread_stub>:
{
 ...
 8d3:	83 ec 14             	sub    $0x14,%esp
    fn(arg);
 8d6:	ff 75 0c             	push   0xc(%ebp)
 8d9:	ff 55 08             	call   *0x8(%ebp)
    table[cur].state = TS_ZOMBIE;
 8dc:	69 05 44 0e 00 00 0c 	imul   $0x100c,0xe44,%eax
 8e3:	10 00 00 
 8e6:	83 c4 10             	add    $0x10,%esp
 8e9:	c7 80 64 0e 00 00 03 	movl   $0x3,0xe64(%eax)
 8f0:	00 00 00 
 8f3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        thread_yield();
 8f8:	e8 43 ff ff ff       	call   840 <thread_yield>
    while(1)
 8fd:	eb f9                	jmp    8f8 <thread_stub+0x28>
 8ff:	90                   	nop
...
{
 900:	55                   	push   %ebp
 901:	b8 60 0e 00 00       	mov    $0xe60,%eax
 ...
 90c:	53                   	push   %ebx
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 90d:	31 db                	xor    %ebx,%ebx
 90f:	90                   	nop
        if(table[i].tid == tid) break;
 910:	39 10                	cmp    %edx,(%eax)
 912:	74 1c                	je     930 <thread_join+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 914:	83 c3 01             	add    $0x1,%ebx
 917:	05 0c 10 00 00       	add    $0x100c,%eax
 91c:	83 fb 08             	cmp    $0x8,%ebx
 91f:	75 ef                	jne    910 <thread_join+0x10>
 ...
 92a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(table[i].state != TS_ZOMBIE)
 930:	69 c3 0c 10 00 00    	imul   $0x100c,%ebx,%eax
 936:	83 b8 64 0e 00 00 03 	cmpl   $0x3,0xe64(%eax)
 93d:	8d b0 60 0e 00 00    	lea    0xe60(%eax),%esi
 943:	74 0e                	je     953 <thread_join+0x53>
 945:	8d 76 00             	lea    0x0(%esi),%esi
        thread_yield();
 948:	e8 f3 fe ff ff       	call   840 <thread_yield>
    while(table[i].state != TS_ZOMBIE)
 94d:	83 7e 04 03          	cmpl   $0x3,0x4(%esi)
 951:	75 f5                	jne    948 <thread_join+0x48>
    table[i].state = TS_FREE;
 953:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    return 0;
 959:	31 c0                	xor    %eax,%eax
    table[i].state = TS_FREE;
 95b:	c7 83 64 0e 00 00 00 	movl   $0x0,0xe64(%ebx)
 962:	00 00 00 
 965:	5b                   	pop    %ebx
 966:	5e                   	pop    %esi
 967:	5d                   	pop    %ebp
...
void mutex_lock(umutex_t *m)   { while (m->locked) thread_yield(); m->locked = 1; }
 ...
 98e:	74 0b                	je     99b <mutex_lock+0x1b>
 990:	e8 ab fe ff ff       	call   840 <thread_yield>
 995:	8b 03                	mov    (%ebx),%eax
 997:	85 c0                	test   %eax,%eax
 999:	75 f5                	jne    990 <mutex_lock+0x10>
 99b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
 9a1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 9a4:	c9                   	leave
 9a5:	c3                   	ret
 9a6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 9ad:	00 
 9ae:	66 90                	xchg   %ax,%ax

000009b0 <mutex_unlock>:
 9b0:	55                   	push   %ebp
...
uswtch:
 ...
 9c1:	57                   	push   %edi
    ...
    movl  20(%esp), %eax
 9c2:	8b 44 24 14          	mov    0x14(%esp),%eax
    movl  %esp, (%eax)
 9c6:	89 20                	mov    %esp,(%eax)

    movl  24(%esp), %esp
 9c8:	8b 64 24 18          	mov    0x18(%esp),%esp
