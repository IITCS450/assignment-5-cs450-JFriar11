 ...
 1f4:	31 ff                	xor    %edi,%edi
{
 ...
 21d:	50                   	push   %eax
 21e:	8d 81 60 12 00 00    	lea    0x1260(%ecx),%eax
 224:	50                   	push   %eax
 ...
 23b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    buf[m] = '\0';
 23e:	bf 60 12 00 00       	mov    $0x1260,%edi
 243:	89 de                	mov    %ebx,%esi
 245:	c6 81 60 12 00 00 00 	movb   $0x0,0x1260(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2f2:	81 ff 60 12 00 00    	cmp    $0x1260,%edi
 ...
 307:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 30a:	2d 60 12 00 00       	sub    $0x1260,%eax
 30f:	29 45 e0             	sub    %eax,-0x20(%ebp)
 312:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      memmove(buf, p, m);
 315:	51                   	push   %ecx
 316:	57                   	push   %edi
 317:	68 60 12 00 00       	push   $0x1260
 ...
 698:	89 d1                	mov    %edx,%ecx
{
 ...
 6cb:	0f b6 92 9c 0d 00 00 	movzbl 0xd9c(%edx),%edx
 ...
 739:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 7a4:	ff 24 85 44 0d 00 00 	jmp    *0xd44(,%eax,4)
 ...
 8b0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 8b5:	bb 3a 0d 00 00       	mov    $0xd3a,%ebx
 ...
 8c1:	a1 60 16 00 00       	mov    0x1660,%eax
{
 ...
 8ff:	5b                   	pop    %ebx
  freep = p;
 900:	a3 60 16 00 00       	mov    %eax,0x1660
}
 905:	5e                   	pop    %esi
 906:	5f                   	pop    %edi
 907:	5d                   	pop    %ebp
 ...
 916:	72 ce                	jb     8e6 <free+0x26>
{
 ...
 937:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 93a:	a3 60 16 00 00       	mov    %eax,0x1660
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 95c:	8b 15 60 16 00 00    	mov    0x1660,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 99b:	3b 05 60 16 00 00    	cmp    0x1660,%eax
 ...
 9be:	e8 fd fe ff ff       	call   8c0 <free>
  return freep;
 9c3:	8b 15 60 16 00 00    	mov    0x1660,%edx
 ...
 9ec:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 9ef:	89 15 60 16 00 00    	mov    %edx,0x1660
}
 ...
 9ff:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 a00:	c7 05 60 16 00 00 64 	movl   $0x1664,0x1660
 a07:	16 00 00 
    base.s.size = 0;
 a0a:	b8 64 16 00 00       	mov    $0x1664,%eax
    base.s.ptr = freep = prevp = &base;
 a0f:	c7 05 64 16 00 00 64 	movl   $0x1664,0x1664
 a16:	16 00 00 
    base.s.size = 0;
 a19:	c7 05 68 16 00 00 00 	movl   $0x0,0x1668
 a20:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void)
{
 ...
 a40:	a1 80 16 00 00       	mov    0x1680,%eax
        table[i].state = TS_FREE;
 a45:	c7 05 b0 26 00 00 00 	movl   $0x0,0x26b0
 a4c:	00 00 00 
 a4f:	c7 05 bc 36 00 00 00 	movl   $0x0,0x36bc
 a56:	00 00 00 
    table[0].tid   = next_tid++;
 a59:	8d 50 01             	lea    0x1(%eax),%edx
        table[i].state = TS_FREE;
 a5c:	c7 05 c8 46 00 00 00 	movl   $0x0,0x46c8
 a63:	00 00 00 
 a66:	c7 05 d4 56 00 00 00 	movl   $0x0,0x56d4
 a6d:	00 00 00 
 a70:	c7 05 e0 66 00 00 00 	movl   $0x0,0x66e0
 a77:	00 00 00 
 a7a:	c7 05 ec 76 00 00 00 	movl   $0x0,0x76ec
 a81:	00 00 00 
 a84:	c7 05 f8 86 00 00 00 	movl   $0x0,0x86f8
 a8b:	00 00 00 
    table[0].tid   = next_tid++;
 a8e:	89 15 80 16 00 00    	mov    %edx,0x1680
 a94:	a3 a0 16 00 00       	mov    %eax,0x16a0
    table[0].state = TS_RUNNING;
 a99:	c7 05 a4 16 00 00 02 	movl   $0x2,0x16a4
 aa0:	00 00 00 
    cur = 0;
 aa3:	c7 05 84 16 00 00 00 	movl   $0x0,0x1684
 aaa:	00 00 00 
}
 aad:	c3                   	ret
 aae:	66 90                	xchg   %ax,%ax

00000ab0 <thread_create>:

tid_t thread_create(void (*fn)(void*), void *arg)
{
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 ab0:	ba a4 16 00 00       	mov    $0x16a4,%edx
 ...
 ac2:	85 c9                	test   %ecx,%ecx
 ac4:	74 1a                	je     ae0 <thread_create+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 ac6:	83 c0 01             	add    $0x1,%eax
 ac9:	81 c2 0c 10 00 00    	add    $0x100c,%edx
 acf:	83 f8 08             	cmp    $0x8,%eax
 ad2:	75 ec                	jne    ac0 <thread_create+0x10>
 ...
 ada:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
 ...
 ae1:	69 c0 0c 10 00 00    	imul   $0x100c,%eax,%eax
{
 ae7:	89 e5                	mov    %esp,%ebp
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 ae9:	8d 90 8c 26 00 00    	lea    0x268c(%eax),%edx
{
 aef:	53                   	push   %ebx
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 af0:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 af3:	89 90 a8 16 00 00    	mov    %edx,0x16a8(%eax)
    table[i].tid       = next_tid++;
 af9:	8b 15 80 16 00 00    	mov    0x1680,%edx
    *(--sp) = 0xffffffff;        /* fake return address    */
 aff:	c7 80 a0 26 00 00 ff 	movl   $0xffffffff,0x26a0(%eax)
 b06:	ff ff ff 
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 b09:	89 88 a8 26 00 00    	mov    %ecx,0x26a8(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 b0f:	8b 4d 08             	mov    0x8(%ebp),%ecx
    table[i].tid       = next_tid++;
 b12:	8d 5a 01             	lea    0x1(%edx),%ebx
 b15:	89 90 a0 16 00 00    	mov    %edx,0x16a0(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 b1b:	89 88 a4 26 00 00    	mov    %ecx,0x26a4(%eax)
    *(--sp) = (uint)thread_stub; /* eip: ret jumps here    */
 b21:	c7 80 9c 26 00 00 00 	movl   $0xc00,0x269c(%eax)
 b28:	0c 00 00 
    *(--sp) = 0;                 /* ebp                    */
 b2b:	c7 80 98 26 00 00 00 	movl   $0x0,0x2698(%eax)
 b32:	00 00 00 
    *(--sp) = 0;                 /* ebx                    */
 b35:	c7 80 94 26 00 00 00 	movl   $0x0,0x2694(%eax)
 b3c:	00 00 00 
    *(--sp) = 0;                 /* esi                    */
 b3f:	c7 80 90 26 00 00 00 	movl   $0x0,0x2690(%eax)
 b46:	00 00 00 
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 b49:	c7 80 8c 26 00 00 00 	movl   $0x0,0x268c(%eax)
 b50:	00 00 00 
    table[i].tid       = next_tid++;
 b53:	89 1d 80 16 00 00    	mov    %ebx,0x1680
}
 b59:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    table[i].state     = TS_RUNNABLE;
 b5c:	c7 80 a4 16 00 00 01 	movl   $0x1,0x16a4(%eax)
 b63:	00 00 00 
}
...
void thread_yield(void)
{
 ...
 b76:	83 ec 0c             	sub    $0xc,%esp
    int old  = cur;
 b79:	8b 1d 84 16 00 00    	mov    0x1684,%ebx
    for(i = 1; i <= MAX_THREADS; i++){
 b7f:	8d 53 01             	lea    0x1(%ebx),%edx
 b82:	8d 73 09             	lea    0x9(%ebx),%esi
 ...
 b90:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
 b93:	83 e0 07             	and    $0x7,%eax
 b96:	29 c8                	sub    %ecx,%eax
        if(table[idx].state == TS_RUNNABLE)
 b98:	69 c8 0c 10 00 00    	imul   $0x100c,%eax,%ecx
 b9e:	83 b9 a4 16 00 00 01 	cmpl   $0x1,0x16a4(%ecx)
 ba5:	8d b9 a0 16 00 00    	lea    0x16a0(%ecx),%edi
 bab:	74 13                	je     bc0 <thread_yield+0x50>
    for(i = 1; i <= MAX_THREADS; i++){
 bad:	83 c2 01             	add    $0x1,%edx
 bb0:	39 f2                	cmp    %esi,%edx
 bb2:	75 d4                	jne    b88 <thread_yield+0x18>
 ...
 bbc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(next == -1) return;
 bc0:	83 f8 ff             	cmp    $0xffffffff,%eax
 bc3:	74 ef                	je     bb4 <thread_yield+0x44>
    table[old].state  = TS_RUNNABLE;
 bc5:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 bcb:	83 ec 08             	sub    $0x8,%esp
    cur = next;
 bce:	a3 84 16 00 00       	mov    %eax,0x1684
    table[old].state  = TS_RUNNABLE;
 bd3:	c7 83 a4 16 00 00 01 	movl   $0x1,0x16a4(%ebx)
 bda:	00 00 00 
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 bdd:	81 c3 a8 16 00 00    	add    $0x16a8,%ebx
    table[next].state = TS_RUNNING;
 be3:	c7 47 04 02 00 00 00 	movl   $0x2,0x4(%edi)
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 bea:	ff 77 08             	push   0x8(%edi)
 bed:	53                   	push   %ebx
 bee:	e8 fb 00 00 00       	call   cee <uswtch>
 bf3:	83 c4 10             	add    $0x10,%esp
}
 bf6:	8d 65 f4             	lea    -0xc(%ebp),%esp
 bf9:	5b                   	pop    %ebx
 bfa:	5e                   	pop    %esi
 bfb:	5f                   	pop    %edi
 bfc:	5d                   	pop    %ebp
...
00000c00 <thread_stub>:
{
 c00:	55                   	push   %ebp
 c01:	89 e5                	mov    %esp,%ebp
 c03:	83 ec 14             	sub    $0x14,%esp
    fn(arg);
 c06:	ff 75 0c             	push   0xc(%ebp)
 c09:	ff 55 08             	call   *0x8(%ebp)
    table[cur].state = TS_ZOMBIE;
 c0c:	69 05 84 16 00 00 0c 	imul   $0x100c,0x1684,%eax
 c13:	10 00 00 
 c16:	83 c4 10             	add    $0x10,%esp
 c19:	c7 80 a4 16 00 00 03 	movl   $0x3,0x16a4(%eax)
 c20:	00 00 00 
 c23:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        thread_yield();
 c28:	e8 43 ff ff ff       	call   b70 <thread_yield>
    while(1)
 c2d:	eb f9                	jmp    c28 <thread_stub+0x28>
 c2f:	90                   	nop

00000c30 <thread_join>:

int thread_join(tid_t tid)
{
 c30:	55                   	push   %ebp
 c31:	b8 a0 16 00 00       	mov    $0x16a0,%eax
 ...
 c3c:	53                   	push   %ebx
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 c3d:	31 db                	xor    %ebx,%ebx
 c3f:	90                   	nop
        if(table[i].tid == tid) break;
 c40:	39 10                	cmp    %edx,(%eax)
 c42:	74 1c                	je     c60 <thread_join+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 c44:	83 c3 01             	add    $0x1,%ebx
 c47:	05 0c 10 00 00       	add    $0x100c,%eax
 c4c:	83 fb 08             	cmp    $0x8,%ebx
 c4f:	75 ef                	jne    c40 <thread_join+0x10>
 ...
 c5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(table[i].state != TS_ZOMBIE)
 c60:	69 c3 0c 10 00 00    	imul   $0x100c,%ebx,%eax
 c66:	83 b8 a4 16 00 00 03 	cmpl   $0x3,0x16a4(%eax)
 c6d:	8d b0 a0 16 00 00    	lea    0x16a0(%eax),%esi
 c73:	74 0e                	je     c83 <thread_join+0x53>
 c75:	8d 76 00             	lea    0x0(%esi),%esi
        thread_yield();
 c78:	e8 f3 fe ff ff       	call   b70 <thread_yield>
    while(table[i].state != TS_ZOMBIE)
 c7d:	83 7e 04 03          	cmpl   $0x3,0x4(%esi)
 c81:	75 f5                	jne    c78 <thread_join+0x48>
    table[i].state = TS_FREE;
 c83:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    return 0;
 c89:	31 c0                	xor    %eax,%eax
    table[i].state = TS_FREE;
 c8b:	c7 83 a4 16 00 00 00 	movl   $0x0,0x16a4(%ebx)
 c92:	00 00 00 
 c95:	5b                   	pop    %ebx
 c96:	5e                   	pop    %esi
 c97:	5d                   	pop    %ebp
...
void mutex_lock(umutex_t *m)   { while (m->locked) thread_yield(); m->locked = 1; }
 ...
 cba:	8b 03                	mov    (%ebx),%eax
 cbc:	85 c0                	test   %eax,%eax
 cbe:	74 0b                	je     ccb <mutex_lock+0x1b>
 cc0:	e8 ab fe ff ff       	call   b70 <thread_yield>
 ...
 cd4:	c9                   	leave
 cd5:	c3                   	ret
 cd6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 cdd:	00 
...
uswtch:
 ...
 cf1:	57                   	push   %edi
    ...
    movl  20(%esp), %eax
 cf2:	8b 44 24 14          	mov    0x14(%esp),%eax
    movl  %esp, (%eax)
 cf6:	89 20                	mov    %esp,(%eax)

    movl  24(%esp), %esp
 cf8:	8b 64 24 18          	mov    0x18(%esp),%esp
