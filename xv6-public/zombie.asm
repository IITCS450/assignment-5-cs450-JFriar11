 ...
 328:	89 d1                	mov    %edx,%ecx
{
 ...
 35b:	0f b6 92 f4 09 00 00 	movzbl 0x9f4(%edx),%edx
 ...
 3c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 434:	ff 24 85 9c 09 00 00 	jmp    *0x99c(,%eax,4)
 ...
 540:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 545:	bb 94 09 00 00       	mov    $0x994,%ebx
...
free(void *ap)
{
 ...
 551:	a1 c0 0d 00 00       	mov    0xdc0,%eax
{
 ...
 58f:	5b                   	pop    %ebx
  freep = p;
 590:	a3 c0 0d 00 00       	mov    %eax,0xdc0
}
 595:	5e                   	pop    %esi
 596:	5f                   	pop    %edi
 597:	5d                   	pop    %ebp
 ...
 5a6:	72 ce                	jb     576 <free+0x26>
{
 ...
 5c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5ca:	a3 c0 0d 00 00       	mov    %eax,0xdc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 5e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5ec:	8b 15 c0 0d 00 00    	mov    0xdc0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 62b:	3b 05 c0 0d 00 00    	cmp    0xdc0,%eax
 ...
 64e:	e8 fd fe ff ff       	call   550 <free>
  return freep;
 653:	8b 15 c0 0d 00 00    	mov    0xdc0,%edx
 ...
 67c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 67f:	89 15 c0 0d 00 00    	mov    %edx,0xdc0
}
 ...
 68f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 690:	c7 05 c0 0d 00 00 c4 	movl   $0xdc4,0xdc0
 697:	0d 00 00 
    base.s.size = 0;
 69a:	b8 c4 0d 00 00       	mov    $0xdc4,%eax
    base.s.ptr = freep = prevp = &base;
 69f:	c7 05 c4 0d 00 00 c4 	movl   $0xdc4,0xdc4
 6a6:	0d 00 00 
    base.s.size = 0;
 6a9:	c7 05 c8 0d 00 00 00 	movl   $0x0,0xdc8
 6b0:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void)
{
 ...
 6d0:	a1 e0 0d 00 00       	mov    0xde0,%eax
        table[i].state = TS_FREE;
 6d5:	c7 05 10 1e 00 00 00 	movl   $0x0,0x1e10
 6dc:	00 00 00 
 6df:	c7 05 1c 2e 00 00 00 	movl   $0x0,0x2e1c
 6e6:	00 00 00 
    table[0].tid   = next_tid++;
 6e9:	8d 50 01             	lea    0x1(%eax),%edx
        table[i].state = TS_FREE;
 6ec:	c7 05 28 3e 00 00 00 	movl   $0x0,0x3e28
 6f3:	00 00 00 
 6f6:	c7 05 34 4e 00 00 00 	movl   $0x0,0x4e34
 6fd:	00 00 00 
 700:	c7 05 40 5e 00 00 00 	movl   $0x0,0x5e40
 707:	00 00 00 
 70a:	c7 05 4c 6e 00 00 00 	movl   $0x0,0x6e4c
 711:	00 00 00 
 714:	c7 05 58 7e 00 00 00 	movl   $0x0,0x7e58
 71b:	00 00 00 
    table[0].tid   = next_tid++;
 71e:	89 15 e0 0d 00 00    	mov    %edx,0xde0
 724:	a3 00 0e 00 00       	mov    %eax,0xe00
    table[0].state = TS_RUNNING;
 729:	c7 05 04 0e 00 00 02 	movl   $0x2,0xe04
 730:	00 00 00 
    cur = 0;
 733:	c7 05 e4 0d 00 00 00 	movl   $0x0,0xde4
 73a:	00 00 00 
}
 73d:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg)
{
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 740:	ba 04 0e 00 00       	mov    $0xe04,%edx
 745:	31 c0                	xor    %eax,%eax
 747:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 74e:	00 
 74f:	90                   	nop
        if(table[i].state == TS_FREE) break;
 750:	8b 0a                	mov    (%edx),%ecx
 752:	85 c9                	test   %ecx,%ecx
 754:	74 1a                	je     770 <thread_create+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 756:	83 c0 01             	add    $0x1,%eax
 759:	81 c2 0c 10 00 00    	add    $0x100c,%edx
 75f:	83 f8 08             	cmp    $0x8,%eax
 762:	75 ec                	jne    750 <thread_create+0x10>
 ...
 764:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 769:	c3                   	ret
 76a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
 770:	55                   	push   %ebp
    uint *sp = (uint*)(table[i].stack + STACK_SIZE);
 771:	69 c0 0c 10 00 00    	imul   $0x100c,%eax,%eax
{
 777:	89 e5                	mov    %esp,%ebp
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 779:	8d 90 ec 1d 00 00    	lea    0x1dec(%eax),%edx
{
 77f:	53                   	push   %ebx
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 780:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 783:	89 90 08 0e 00 00    	mov    %edx,0xe08(%eax)
    table[i].tid       = next_tid++;
 789:	8b 15 e0 0d 00 00    	mov    0xde0,%edx
    *(--sp) = 0xffffffff;        /* fake return address    */
 78f:	c7 80 00 1e 00 00 ff 	movl   $0xffffffff,0x1e00(%eax)
 796:	ff ff ff 
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 799:	89 88 08 1e 00 00    	mov    %ecx,0x1e08(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 79f:	8b 4d 08             	mov    0x8(%ebp),%ecx
    table[i].tid       = next_tid++;
 7a2:	8d 5a 01             	lea    0x1(%edx),%ebx
 7a5:	89 90 00 0e 00 00    	mov    %edx,0xe00(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 7ab:	89 88 04 1e 00 00    	mov    %ecx,0x1e04(%eax)
    *(--sp) = (uint)thread_stub; /* eip: ret jumps here    */
 7b1:	c7 80 fc 1d 00 00 90 	movl   $0x890,0x1dfc(%eax)
 7b8:	08 00 00 
    *(--sp) = 0;                 /* ebp                    */
 7bb:	c7 80 f8 1d 00 00 00 	movl   $0x0,0x1df8(%eax)
 7c2:	00 00 00 
    *(--sp) = 0;                 /* ebx                    */
 7c5:	c7 80 f4 1d 00 00 00 	movl   $0x0,0x1df4(%eax)
 7cc:	00 00 00 
    *(--sp) = 0;                 /* esi                    */
 7cf:	c7 80 f0 1d 00 00 00 	movl   $0x0,0x1df0(%eax)
 7d6:	00 00 00 
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 7d9:	c7 80 ec 1d 00 00 00 	movl   $0x0,0x1dec(%eax)
 7e0:	00 00 00 
    table[i].tid       = next_tid++;
 7e3:	89 1d e0 0d 00 00    	mov    %ebx,0xde0
}
 7e9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    table[i].state     = TS_RUNNABLE;
 7ec:	c7 80 04 0e 00 00 01 	movl   $0x1,0xe04(%eax)
 7f3:	00 00 00 
}
...
void thread_yield(void)
{
 ...
 806:	83 ec 0c             	sub    $0xc,%esp
    int old  = cur;
 809:	8b 1d e4 0d 00 00    	mov    0xde4,%ebx
    for(i = 1; i <= MAX_THREADS; i++){
 80f:	8d 53 01             	lea    0x1(%ebx),%edx
 812:	8d 73 09             	lea    0x9(%ebx),%esi
 815:	8d 76 00             	lea    0x0(%esi),%esi
        int idx = (cur + i) % MAX_THREADS;
 818:	89 d1                	mov    %edx,%ecx
 81a:	c1 f9 1f             	sar    $0x1f,%ecx
 81d:	c1 e9 1d             	shr    $0x1d,%ecx
 820:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
 823:	83 e0 07             	and    $0x7,%eax
 826:	29 c8                	sub    %ecx,%eax
        if(table[idx].state == TS_RUNNABLE)
 828:	69 c8 0c 10 00 00    	imul   $0x100c,%eax,%ecx
 82e:	83 b9 04 0e 00 00 01 	cmpl   $0x1,0xe04(%ecx)
 835:	8d b9 00 0e 00 00    	lea    0xe00(%ecx),%edi
 83b:	74 13                	je     850 <thread_yield+0x50>
    for(i = 1; i <= MAX_THREADS; i++){
 83d:	83 c2 01             	add    $0x1,%edx
 840:	39 f2                	cmp    %esi,%edx
 842:	75 d4                	jne    818 <thread_yield+0x18>
 ...
 853:	74 ef                	je     844 <thread_yield+0x44>
    table[old].state  = TS_RUNNABLE;
 855:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 85b:	83 ec 08             	sub    $0x8,%esp
    cur = next;
 85e:	a3 e4 0d 00 00       	mov    %eax,0xde4
    table[old].state  = TS_RUNNABLE;
 863:	c7 83 04 0e 00 00 01 	movl   $0x1,0xe04(%ebx)
 86a:	00 00 00 
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 86d:	81 c3 08 0e 00 00    	add    $0xe08,%ebx
    table[next].state = TS_RUNNING;
 873:	c7 47 04 02 00 00 00 	movl   $0x2,0x4(%edi)
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 87a:	ff 77 08             	push   0x8(%edi)
 87d:	53                   	push   %ebx
 87e:	e8 fb 00 00 00       	call   97e <uswtch>
...
00000890 <thread_stub>:
{
 890:	55                   	push   %ebp
 891:	89 e5                	mov    %esp,%ebp
 893:	83 ec 14             	sub    $0x14,%esp
    fn(arg);
 896:	ff 75 0c             	push   0xc(%ebp)
 899:	ff 55 08             	call   *0x8(%ebp)
    table[cur].state = TS_ZOMBIE;
 89c:	69 05 e4 0d 00 00 0c 	imul   $0x100c,0xde4,%eax
 8a3:	10 00 00 
 8a6:	83 c4 10             	add    $0x10,%esp
 8a9:	c7 80 04 0e 00 00 03 	movl   $0x3,0xe04(%eax)
 8b0:	00 00 00 
 8b3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        thread_yield();
 8b8:	e8 43 ff ff ff       	call   800 <thread_yield>
    while(1)
 8bd:	eb f9                	jmp    8b8 <thread_stub+0x28>
 8bf:	90                   	nop

000008c0 <thread_join>:

int thread_join(tid_t tid)
{
 8c0:	55                   	push   %ebp
 8c1:	b8 00 0e 00 00       	mov    $0xe00,%eax
 ...
 8cc:	53                   	push   %ebx
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 8cd:	31 db                	xor    %ebx,%ebx
 8cf:	90                   	nop
        if(table[i].tid == tid) break;
 8d0:	39 10                	cmp    %edx,(%eax)
 8d2:	74 1c                	je     8f0 <thread_join+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 8d4:	83 c3 01             	add    $0x1,%ebx
 8d7:	05 0c 10 00 00       	add    $0x100c,%eax
 8dc:	83 fb 08             	cmp    $0x8,%ebx
 8df:	75 ef                	jne    8d0 <thread_join+0x10>
 ...
 8e2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 8e7:	5e                   	pop    %esi
 8e8:	5d                   	pop    %ebp
 8e9:	c3                   	ret
 8ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(table[i].state != TS_ZOMBIE)
 8f0:	69 c3 0c 10 00 00    	imul   $0x100c,%ebx,%eax
 8f6:	83 b8 04 0e 00 00 03 	cmpl   $0x3,0xe04(%eax)
 8fd:	8d b0 00 0e 00 00    	lea    0xe00(%eax),%esi
 903:	74 0e                	je     913 <thread_join+0x53>
 905:	8d 76 00             	lea    0x0(%esi),%esi
        thread_yield();
 908:	e8 f3 fe ff ff       	call   800 <thread_yield>
    while(table[i].state != TS_ZOMBIE)
 90d:	83 7e 04 03          	cmpl   $0x3,0x4(%esi)
 911:	75 f5                	jne    908 <thread_join+0x48>
    table[i].state = TS_FREE;
 913:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    return 0;
 919:	31 c0                	xor    %eax,%eax
    table[i].state = TS_FREE;
 91b:	c7 83 04 0e 00 00 00 	movl   $0x0,0xe04(%ebx)
 922:	00 00 00 
 925:	5b                   	pop    %ebx
 926:	5e                   	pop    %esi
 927:	5d                   	pop    %ebp
...
void mutex_lock(umutex_t *m)   { while (m->locked) thread_yield(); m->locked = 1; }
 ...
 950:	e8 ab fe ff ff       	call   800 <thread_yield>
 ...
 964:	c9                   	leave
 965:	c3                   	ret
 966:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 96d:	00 
...
uswtch:
 ...
 981:	57                   	push   %edi
    ...
    movl  20(%esp), %eax
 982:	8b 44 24 14          	mov    0x14(%esp),%eax
    movl  %esp, (%eax)
 986:	89 20                	mov    %esp,(%eax)

    movl  24(%esp), %esp
 988:	8b 64 24 18          	mov    0x18(%esp),%esp
