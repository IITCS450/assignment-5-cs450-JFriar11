 ...
 358:	89 d1                	mov    %edx,%ecx
{
 ...
 38b:	0f b6 92 4c 0a 00 00 	movzbl 0xa4c(%edx),%edx
 ...
 3f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 464:	ff 24 85 f4 09 00 00 	jmp    *0x9f4(,%eax,4)
 ...
 570:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 575:	bb eb 09 00 00       	mov    $0x9eb,%ebx
...
free(void *ap)
{
 ...
 581:	a1 20 0e 00 00       	mov    0xe20,%eax
{
 ...
 5bf:	5b                   	pop    %ebx
  freep = p;
 5c0:	a3 20 0e 00 00       	mov    %eax,0xe20
}
 5c5:	5e                   	pop    %esi
 5c6:	5f                   	pop    %edi
 5c7:	5d                   	pop    %ebp
 ...
 5d6:	72 ce                	jb     5a6 <free+0x26>
{
 ...
 5f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5fa:	a3 20 0e 00 00       	mov    %eax,0xe20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 20 0e 00 00    	mov    0xe20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65b:	3b 05 20 0e 00 00    	cmp    0xe20,%eax
 ...
 67e:	e8 fd fe ff ff       	call   580 <free>
  return freep;
 683:	8b 15 20 0e 00 00    	mov    0xe20,%edx
 ...
 6ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6af:	89 15 20 0e 00 00    	mov    %edx,0xe20
}
 ...
 6bf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6c0:	c7 05 20 0e 00 00 24 	movl   $0xe24,0xe20
 6c7:	0e 00 00 
    base.s.size = 0;
 6ca:	b8 24 0e 00 00       	mov    $0xe24,%eax
    base.s.ptr = freep = prevp = &base;
 6cf:	c7 05 24 0e 00 00 24 	movl   $0xe24,0xe24
 6d6:	0e 00 00 
    base.s.size = 0;
 6d9:	c7 05 28 0e 00 00 00 	movl   $0x0,0xe28
 6e0:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void)
{
 ...
 700:	a1 40 0e 00 00       	mov    0xe40,%eax
        table[i].state = TS_FREE;
 705:	c7 05 70 1e 00 00 00 	movl   $0x0,0x1e70
 70c:	00 00 00 
 70f:	c7 05 7c 2e 00 00 00 	movl   $0x0,0x2e7c
 716:	00 00 00 
    table[0].tid   = next_tid++;
 719:	8d 50 01             	lea    0x1(%eax),%edx
        table[i].state = TS_FREE;
 71c:	c7 05 88 3e 00 00 00 	movl   $0x0,0x3e88
 723:	00 00 00 
 726:	c7 05 94 4e 00 00 00 	movl   $0x0,0x4e94
 72d:	00 00 00 
 730:	c7 05 a0 5e 00 00 00 	movl   $0x0,0x5ea0
 737:	00 00 00 
 73a:	c7 05 ac 6e 00 00 00 	movl   $0x0,0x6eac
 741:	00 00 00 
 744:	c7 05 b8 7e 00 00 00 	movl   $0x0,0x7eb8
 74b:	00 00 00 
    table[0].tid   = next_tid++;
 74e:	89 15 40 0e 00 00    	mov    %edx,0xe40
 754:	a3 60 0e 00 00       	mov    %eax,0xe60
    table[0].state = TS_RUNNING;
 759:	c7 05 64 0e 00 00 02 	movl   $0x2,0xe64
 760:	00 00 00 
    cur = 0;
 763:	c7 05 44 0e 00 00 00 	movl   $0x0,0xe44
 76a:	00 00 00 
}
 76d:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg)
{
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 770:	ba 64 0e 00 00       	mov    $0xe64,%edx
 ...
 784:	74 1a                	je     7a0 <thread_create+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 786:	83 c0 01             	add    $0x1,%eax
 789:	81 c2 0c 10 00 00    	add    $0x100c,%edx
 78f:	83 f8 08             	cmp    $0x8,%eax
 792:	75 ec                	jne    780 <thread_create+0x10>
 ...
 794:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 799:	c3                   	ret
 79a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
 7a0:	55                   	push   %ebp
    uint *sp = (uint*)(table[i].stack + STACK_SIZE);
 7a1:	69 c0 0c 10 00 00    	imul   $0x100c,%eax,%eax
{
 7a7:	89 e5                	mov    %esp,%ebp
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 7a9:	8d 90 4c 1e 00 00    	lea    0x1e4c(%eax),%edx
{
 7af:	53                   	push   %ebx
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 7b0:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 7b3:	89 90 68 0e 00 00    	mov    %edx,0xe68(%eax)
    table[i].tid       = next_tid++;
 7b9:	8b 15 40 0e 00 00    	mov    0xe40,%edx
    *(--sp) = 0xffffffff;        /* fake return address    */
 7bf:	c7 80 60 1e 00 00 ff 	movl   $0xffffffff,0x1e60(%eax)
 7c6:	ff ff ff 
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 7c9:	89 88 68 1e 00 00    	mov    %ecx,0x1e68(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 7cf:	8b 4d 08             	mov    0x8(%ebp),%ecx
    table[i].tid       = next_tid++;
 7d2:	8d 5a 01             	lea    0x1(%edx),%ebx
 7d5:	89 90 60 0e 00 00    	mov    %edx,0xe60(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 7db:	89 88 64 1e 00 00    	mov    %ecx,0x1e64(%eax)
    *(--sp) = (uint)thread_stub; /* eip: ret jumps here    */
 7e1:	c7 80 5c 1e 00 00 c0 	movl   $0x8c0,0x1e5c(%eax)
 7e8:	08 00 00 
    *(--sp) = 0;                 /* ebp                    */
 7eb:	c7 80 58 1e 00 00 00 	movl   $0x0,0x1e58(%eax)
 7f2:	00 00 00 
    *(--sp) = 0;                 /* ebx                    */
 7f5:	c7 80 54 1e 00 00 00 	movl   $0x0,0x1e54(%eax)
 7fc:	00 00 00 
    *(--sp) = 0;                 /* esi                    */
 7ff:	c7 80 50 1e 00 00 00 	movl   $0x0,0x1e50(%eax)
 806:	00 00 00 
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 809:	c7 80 4c 1e 00 00 00 	movl   $0x0,0x1e4c(%eax)
 810:	00 00 00 
    table[i].tid       = next_tid++;
 813:	89 1d 40 0e 00 00    	mov    %ebx,0xe40
}
 819:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    table[i].state     = TS_RUNNABLE;
 81c:	c7 80 64 0e 00 00 01 	movl   $0x1,0xe64(%eax)
 823:	00 00 00 
}
...
void thread_yield(void)
{
 ...
 836:	83 ec 0c             	sub    $0xc,%esp
    int old  = cur;
 839:	8b 1d 44 0e 00 00    	mov    0xe44,%ebx
    for(i = 1; i <= MAX_THREADS; i++){
 83f:	8d 53 01             	lea    0x1(%ebx),%edx
 842:	8d 73 09             	lea    0x9(%ebx),%esi
 ...
 850:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
 853:	83 e0 07             	and    $0x7,%eax
 856:	29 c8                	sub    %ecx,%eax
        if(table[idx].state == TS_RUNNABLE)
 858:	69 c8 0c 10 00 00    	imul   $0x100c,%eax,%ecx
 85e:	83 b9 64 0e 00 00 01 	cmpl   $0x1,0xe64(%ecx)
 865:	8d b9 60 0e 00 00    	lea    0xe60(%ecx),%edi
 86b:	74 13                	je     880 <thread_yield+0x50>
    for(i = 1; i <= MAX_THREADS; i++){
 86d:	83 c2 01             	add    $0x1,%edx
 870:	39 f2                	cmp    %esi,%edx
 872:	75 d4                	jne    848 <thread_yield+0x18>
 ...
 87c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(next == -1) return;
 880:	83 f8 ff             	cmp    $0xffffffff,%eax
 883:	74 ef                	je     874 <thread_yield+0x44>
    table[old].state  = TS_RUNNABLE;
 885:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 88b:	83 ec 08             	sub    $0x8,%esp
    cur = next;
 88e:	a3 44 0e 00 00       	mov    %eax,0xe44
    table[old].state  = TS_RUNNABLE;
 893:	c7 83 64 0e 00 00 01 	movl   $0x1,0xe64(%ebx)
 89a:	00 00 00 
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 89d:	81 c3 68 0e 00 00    	add    $0xe68,%ebx
    table[next].state = TS_RUNNING;
 8a3:	c7 47 04 02 00 00 00 	movl   $0x2,0x4(%edi)
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 8aa:	ff 77 08             	push   0x8(%edi)
 8ad:	53                   	push   %ebx
 8ae:	e8 fb 00 00 00       	call   9ae <uswtch>
...
000008c0 <thread_stub>:
{
 8c0:	55                   	push   %ebp
 8c1:	89 e5                	mov    %esp,%ebp
 8c3:	83 ec 14             	sub    $0x14,%esp
    fn(arg);
 8c6:	ff 75 0c             	push   0xc(%ebp)
 8c9:	ff 55 08             	call   *0x8(%ebp)
    table[cur].state = TS_ZOMBIE;
 8cc:	69 05 44 0e 00 00 0c 	imul   $0x100c,0xe44,%eax
 8d3:	10 00 00 
 8d6:	83 c4 10             	add    $0x10,%esp
 8d9:	c7 80 64 0e 00 00 03 	movl   $0x3,0xe64(%eax)
 8e0:	00 00 00 
 8e3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        thread_yield();
 8e8:	e8 43 ff ff ff       	call   830 <thread_yield>
    while(1)
 8ed:	eb f9                	jmp    8e8 <thread_stub+0x28>
 8ef:	90                   	nop
...
{
 8f0:	55                   	push   %ebp
 8f1:	b8 60 0e 00 00       	mov    $0xe60,%eax
 ...
 8fc:	53                   	push   %ebx
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 8fd:	31 db                	xor    %ebx,%ebx
 8ff:	90                   	nop
        if(table[i].tid == tid) break;
 900:	39 10                	cmp    %edx,(%eax)
 902:	74 1c                	je     920 <thread_join+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 904:	83 c3 01             	add    $0x1,%ebx
 907:	05 0c 10 00 00       	add    $0x100c,%eax
 90c:	83 fb 08             	cmp    $0x8,%ebx
 90f:	75 ef                	jne    900 <thread_join+0x10>
 ...
 91a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(table[i].state != TS_ZOMBIE)
 920:	69 c3 0c 10 00 00    	imul   $0x100c,%ebx,%eax
 926:	83 b8 64 0e 00 00 03 	cmpl   $0x3,0xe64(%eax)
 92d:	8d b0 60 0e 00 00    	lea    0xe60(%eax),%esi
 933:	74 0e                	je     943 <thread_join+0x53>
 935:	8d 76 00             	lea    0x0(%esi),%esi
        thread_yield();
 938:	e8 f3 fe ff ff       	call   830 <thread_yield>
    while(table[i].state != TS_ZOMBIE)
 93d:	83 7e 04 03          	cmpl   $0x3,0x4(%esi)
 941:	75 f5                	jne    938 <thread_join+0x48>
    table[i].state = TS_FREE;
 943:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    return 0;
 949:	31 c0                	xor    %eax,%eax
    table[i].state = TS_FREE;
 94b:	c7 83 64 0e 00 00 00 	movl   $0x0,0xe64(%ebx)
 952:	00 00 00 
 955:	5b                   	pop    %ebx
 956:	5e                   	pop    %esi
 957:	5d                   	pop    %ebp
...
void mutex_lock(umutex_t *m)   { while (m->locked) thread_yield(); m->locked = 1; }
 ...
 980:	e8 ab fe ff ff       	call   830 <thread_yield>
...
uswtch:
 ...
 9b1:	57                   	push   %edi
    ...
    movl  20(%esp), %eax
 9b2:	8b 44 24 14          	mov    0x14(%esp),%eax
    movl  %esp, (%eax)
 9b6:	89 20                	mov    %esp,(%eax)

    movl  24(%esp), %esp
 9b8:	8b 64 24 18          	mov    0x18(%esp),%esp
