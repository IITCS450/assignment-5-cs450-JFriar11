...
main(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      40:	80 3d 82 1d 00 00 20 	cmpb   $0x20,0x1d82
...
fork1(void)
{
  ...
  memset(buf, 0, nbuf);
      ...
      79:	6a 64                	push   $0x64
      7b:	6a 00                	push   $0x0
      7d:	68 80 1d 00 00       	push   $0x1d80
      82:	e8 09 0c 00 00       	call   c90 <memset>
  gets(buf, nbuf);
      87:	58                   	pop    %eax
      88:	5a                   	pop    %edx
      89:	6a 64                	push   $0x64
      8b:	68 80 1d 00 00       	push   $0x1d80
      90:	e8 5b 0c 00 00       	call   cf0 <gets>
  if(buf[0] == 0) // EOF
      95:	0f b6 05 80 1d 00 00 	movzbl 0x1d80,%eax
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a7:	80 3d 81 1d 00 00 64 	cmpb   $0x64,0x1d81
  ...
  exit();
     ...
     105:	51                   	push   %ecx
     106:	68 83 1d 00 00       	push   $0x1d83
     10b:	68 dd 15 00 00       	push   $0x15dd
     110:	6a 02                	push   $0x2
    ...
    panic("fork");
     ...
     122:	68 37 15 00 00       	push   $0x1537
...
00000130 <getcmd>:
{
  ...
  printf(2, "$ ");
     ...
     13e:	68 34 15 00 00       	push   $0x1534
     143:	6a 02                	push   $0x2
...
00000170 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     179:	68 d1 15 00 00       	push   $0x15d1
     17e:	6a 02                	push   $0x2
...
00000190 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1a5:	68 37 15 00 00       	push   $0x1537
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 f4 15 00 00 	jmp    *0x15f4(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1e9:	68 43 15 00 00       	push   $0x1543
     1ee:	6a 02                	push   $0x2
    ...
    panic("runcmd");
     ...
     2cf:	68 63 15 00 00       	push   $0x1563
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 74 1d 00 00       	push   $0x1d74
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 74 1d 00 00       	push   $0x1d74
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 6c 1d 00 00       	push   $0x1d6c
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 74 1d 00 00       	push   $0x1d74
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 74 1d 00 00       	push   $0x1d74
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 85 15 00 00       	push   $0x1585
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  return cmd;
     ...
     78e:	68 68 15 00 00       	push   $0x1568
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     7af:	68 88 15 00 00       	push   $0x1588
     7b4:	56                   	push   %esi
     7b5:	53                   	push   %ebx
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     816:	68 9f 15 00 00       	push   $0x159f
     81b:	56                   	push   %esi
     81c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     860:	68 91 15 00 00       	push   $0x1591
  ...
  cmd->eargv[argc] = 0;
     ...
     8a9:	68 8a 15 00 00       	push   $0x158a
...
000008c0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8d9:	68 a4 15 00 00       	push   $0x15a4
  cmd = parseexec(ps, es);
...
00000950 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     9ab:	68 a6 15 00 00       	push   $0x15a6
     9b0:	57                   	push   %edi
     9b1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9c1:	68 a2 15 00 00       	push   $0x15a2
     9c6:	57                   	push   %edi
     9c7:	56                   	push   %esi
...
00000a30 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a3f:	68 88 15 00 00       	push   $0x1588
     a44:	56                   	push   %esi
     a45:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a69:	68 c4 15 00 00       	push   $0x15c4
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ad5:	ff 24 85 0c 16 00 00 	jmp    *0x160c(,%eax,4)
     ...
     b65:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b83:	68 52 15 00 00       	push   $0x1552
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     bae:	52                   	push   %edx
     baf:	50                   	push   %eax
     bb0:	68 c6 15 00 00       	push   $0x15c6
     bb5:	6a 02                	push   $0x2
     bb7:	e8 a4 03 00 00       	call   f60 <printf>
    panic("syntax");
     bbc:	c7 04 24 8a 15 00 00 	movl   $0x158a,(%esp)
     ...
     ec8:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     efb:	0f b6 92 7c 16 00 00 	movzbl 0x167c(%edx),%edx
     ...
     f69:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fd4:	ff 24 85 24 16 00 00 	jmp    *0x1624(,%eax,4)
  ...
  write(fd, &c, 1);
    ...
    10e0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    10e5:	bb eb 15 00 00       	mov    $0x15eb,%ebx
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10f1:	a1 e4 1d 00 00       	mov    0x1de4,%eax
{
  ...
  freep = p;
    ...
    112f:	5b                   	pop    %ebx
  freep = p;
    1130:	a3 e4 1d 00 00       	mov    %eax,0x1de4
}
    1135:	5e                   	pop    %esi
    1136:	5f                   	pop    %edi
    1137:	5d                   	pop    %ebp
    ...
    1146:	72 ce                	jb     1116 <free+0x26>
{
  ...
  freep = p;
    116a:	a3 e4 1d 00 00       	mov    %eax,0x1de4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    118c:	8b 15 e4 1d 00 00    	mov    0x1de4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    11cb:	3b 05 e4 1d 00 00    	cmp    0x1de4,%eax
  ...
  return freep;
    11f3:	8b 15 e4 1d 00 00    	mov    0x1de4,%edx
    ...
    121c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    121f:	89 15 e4 1d 00 00    	mov    %edx,0x1de4
}
    ...
    122f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
    1230:	c7 05 e4 1d 00 00 e8 	movl   $0x1de8,0x1de4
    1237:	1d 00 00 
    base.s.size = 0;
    123a:	b8 e8 1d 00 00       	mov    $0x1de8,%eax
    base.s.ptr = freep = prevp = &base;
    123f:	c7 05 e8 1d 00 00 e8 	movl   $0x1de8,0x1de8
    1246:	1d 00 00 
    base.s.size = 0;
    1249:	c7 05 ec 1d 00 00 00 	movl   $0x0,0x1dec
    1250:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void)
{
    ...
    1270:	a1 00 1e 00 00       	mov    0x1e00,%eax
        table[i].state = TS_FREE;
    1275:	c7 05 30 2e 00 00 00 	movl   $0x0,0x2e30
    127c:	00 00 00 
    127f:	c7 05 3c 3e 00 00 00 	movl   $0x0,0x3e3c
    1286:	00 00 00 
    table[0].tid   = next_tid++;
    1289:	8d 50 01             	lea    0x1(%eax),%edx
        table[i].state = TS_FREE;
    128c:	c7 05 48 4e 00 00 00 	movl   $0x0,0x4e48
    1293:	00 00 00 
    1296:	c7 05 54 5e 00 00 00 	movl   $0x0,0x5e54
    129d:	00 00 00 
    12a0:	c7 05 60 6e 00 00 00 	movl   $0x0,0x6e60
    12a7:	00 00 00 
    12aa:	c7 05 6c 7e 00 00 00 	movl   $0x0,0x7e6c
    12b1:	00 00 00 
    12b4:	c7 05 78 8e 00 00 00 	movl   $0x0,0x8e78
    12bb:	00 00 00 
    table[0].tid   = next_tid++;
    12be:	89 15 00 1e 00 00    	mov    %edx,0x1e00
    12c4:	a3 20 1e 00 00       	mov    %eax,0x1e20
    table[0].state = TS_RUNNING;
    12c9:	c7 05 24 1e 00 00 02 	movl   $0x2,0x1e24
    12d0:	00 00 00 
    cur = 0;
    12d3:	c7 05 04 1e 00 00 00 	movl   $0x0,0x1e04
    12da:	00 00 00 
}
    12dd:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg)
{
    int i;
    for(i = 0; i < MAX_THREADS; i++)
    12e0:	ba 24 1e 00 00       	mov    $0x1e24,%edx
    12e5:	31 c0                	xor    %eax,%eax
    12e7:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    12ee:	00 
    12ef:	90                   	nop
        if(table[i].state == TS_FREE) break;
    12f0:	8b 0a                	mov    (%edx),%ecx
    12f2:	85 c9                	test   %ecx,%ecx
    12f4:	74 1a                	je     1310 <thread_create+0x30>
    for(i = 0; i < MAX_THREADS; i++)
    12f6:	83 c0 01             	add    $0x1,%eax
    12f9:	81 c2 0c 10 00 00    	add    $0x100c,%edx
    12ff:	83 f8 08             	cmp    $0x8,%eax
    1302:	75 ec                	jne    12f0 <thread_create+0x10>
    ...
    1304:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1309:	c3                   	ret
    130a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
    1310:	55                   	push   %ebp
    uint *sp = (uint*)(table[i].stack + STACK_SIZE);
    1311:	69 c0 0c 10 00 00    	imul   $0x100c,%eax,%eax
{
    1317:	89 e5                	mov    %esp,%ebp
    *(--sp) = 0;                 /* edi  <- saved_esp here */
    1319:	8d 90 0c 2e 00 00    	lea    0x2e0c(%eax),%edx
{
    131f:	53                   	push   %ebx
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
    1320:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    *(--sp) = 0;                 /* edi  <- saved_esp here */
    1323:	89 90 28 1e 00 00    	mov    %edx,0x1e28(%eax)
    table[i].tid       = next_tid++;
    1329:	8b 15 00 1e 00 00    	mov    0x1e00,%edx
    *(--sp) = 0xffffffff;        /* fake return address    */
    132f:	c7 80 20 2e 00 00 ff 	movl   $0xffffffff,0x2e20(%eax)
    1336:	ff ff ff 
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
    1339:	89 88 28 2e 00 00    	mov    %ecx,0x2e28(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
    133f:	8b 4d 08             	mov    0x8(%ebp),%ecx
    table[i].tid       = next_tid++;
    1342:	8d 5a 01             	lea    0x1(%edx),%ebx
    1345:	89 90 20 1e 00 00    	mov    %edx,0x1e20(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
    134b:	89 88 24 2e 00 00    	mov    %ecx,0x2e24(%eax)
    *(--sp) = (uint)thread_stub; /* eip: ret jumps here    */
    1351:	c7 80 1c 2e 00 00 30 	movl   $0x1430,0x2e1c(%eax)
    1358:	14 00 00 
    *(--sp) = 0;                 /* ebp                    */
    135b:	c7 80 18 2e 00 00 00 	movl   $0x0,0x2e18(%eax)
    1362:	00 00 00 
    *(--sp) = 0;                 /* ebx                    */
    1365:	c7 80 14 2e 00 00 00 	movl   $0x0,0x2e14(%eax)
    136c:	00 00 00 
    *(--sp) = 0;                 /* esi                    */
    136f:	c7 80 10 2e 00 00 00 	movl   $0x0,0x2e10(%eax)
    1376:	00 00 00 
    *(--sp) = 0;                 /* edi  <- saved_esp here */
    1379:	c7 80 0c 2e 00 00 00 	movl   $0x0,0x2e0c(%eax)
    1380:	00 00 00 
    table[i].tid       = next_tid++;
    1383:	89 1d 00 1e 00 00    	mov    %ebx,0x1e00
}
    1389:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    table[i].state     = TS_RUNNABLE;
    138c:	c7 80 24 1e 00 00 01 	movl   $0x1,0x1e24(%eax)
    1393:	00 00 00 
}
...
void thread_yield(void)
{
    ...
    int old  = cur;
    13a9:	8b 1d 04 1e 00 00    	mov    0x1e04,%ebx
    for(i = 1; i <= MAX_THREADS; i++){
    13af:	8d 53 01             	lea    0x1(%ebx),%edx
    13b2:	8d 73 09             	lea    0x9(%ebx),%esi
    13b5:	8d 76 00             	lea    0x0(%esi),%esi
        int idx = (cur + i) % MAX_THREADS;
    13b8:	89 d1                	mov    %edx,%ecx
    13ba:	c1 f9 1f             	sar    $0x1f,%ecx
    13bd:	c1 e9 1d             	shr    $0x1d,%ecx
    13c0:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
    13c3:	83 e0 07             	and    $0x7,%eax
    13c6:	29 c8                	sub    %ecx,%eax
        if(table[idx].state == TS_RUNNABLE)
    13c8:	69 c8 0c 10 00 00    	imul   $0x100c,%eax,%ecx
    13ce:	83 b9 24 1e 00 00 01 	cmpl   $0x1,0x1e24(%ecx)
    13d5:	8d b9 20 1e 00 00    	lea    0x1e20(%ecx),%edi
    13db:	74 13                	je     13f0 <thread_yield+0x50>
    for(i = 1; i <= MAX_THREADS; i++){
    13dd:	83 c2 01             	add    $0x1,%edx
    13e0:	39 f2                	cmp    %esi,%edx
    13e2:	75 d4                	jne    13b8 <thread_yield+0x18>
    ...
    13f3:	74 ef                	je     13e4 <thread_yield+0x44>
    table[old].state  = TS_RUNNABLE;
    13f5:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    uswtch(&table[old].saved_esp, table[next].saved_esp);
    13fb:	83 ec 08             	sub    $0x8,%esp
    cur = next;
    13fe:	a3 04 1e 00 00       	mov    %eax,0x1e04
    table[old].state  = TS_RUNNABLE;
    1403:	c7 83 24 1e 00 00 01 	movl   $0x1,0x1e24(%ebx)
    140a:	00 00 00 
    uswtch(&table[old].saved_esp, table[next].saved_esp);
    140d:	81 c3 28 1e 00 00    	add    $0x1e28,%ebx
    table[next].state = TS_RUNNING;
    1413:	c7 47 04 02 00 00 00 	movl   $0x2,0x4(%edi)
    uswtch(&table[old].saved_esp, table[next].saved_esp);
    141a:	ff 77 08             	push   0x8(%edi)
    141d:	53                   	push   %ebx
    141e:	e8 fb 00 00 00       	call   151e <uswtch>
    1423:	83 c4 10             	add    $0x10,%esp
}
    1426:	8d 65 f4             	lea    -0xc(%ebp),%esp
    1429:	5b                   	pop    %ebx
    142a:	5e                   	pop    %esi
    142b:	5f                   	pop    %edi
    142c:	5d                   	pop    %ebp
...
00001430 <thread_stub>:
{
    1430:	55                   	push   %ebp
    1431:	89 e5                	mov    %esp,%ebp
    1433:	83 ec 14             	sub    $0x14,%esp
    fn(arg);
    1436:	ff 75 0c             	push   0xc(%ebp)
    1439:	ff 55 08             	call   *0x8(%ebp)
    table[cur].state = TS_ZOMBIE;
    143c:	69 05 04 1e 00 00 0c 	imul   $0x100c,0x1e04,%eax
    1443:	10 00 00 
    1446:	83 c4 10             	add    $0x10,%esp
    1449:	c7 80 24 1e 00 00 03 	movl   $0x3,0x1e24(%eax)
    1450:	00 00 00 
    1453:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        thread_yield();
    1458:	e8 43 ff ff ff       	call   13a0 <thread_yield>
    while(1)
    145d:	eb f9                	jmp    1458 <thread_stub+0x28>
    145f:	90                   	nop
...
{
    1460:	55                   	push   %ebp
    1461:	b8 20 1e 00 00       	mov    $0x1e20,%eax
    ...
    int i;
    for(i = 0; i < MAX_THREADS; i++)
    146d:	31 db                	xor    %ebx,%ebx
    146f:	90                   	nop
        if(table[i].tid == tid) break;
    1470:	39 10                	cmp    %edx,(%eax)
    1472:	74 1c                	je     1490 <thread_join+0x30>
    for(i = 0; i < MAX_THREADS; i++)
    1474:	83 c3 01             	add    $0x1,%ebx
    1477:	05 0c 10 00 00       	add    $0x100c,%eax
    147c:	83 fb 08             	cmp    $0x8,%ebx
    147f:	75 ef                	jne    1470 <thread_join+0x10>
    ...
    while(table[i].state != TS_ZOMBIE)
    1490:	69 c3 0c 10 00 00    	imul   $0x100c,%ebx,%eax
    1496:	83 b8 24 1e 00 00 03 	cmpl   $0x3,0x1e24(%eax)
    149d:	8d b0 20 1e 00 00    	lea    0x1e20(%eax),%esi
    14a3:	74 0e                	je     14b3 <thread_join+0x53>
    14a5:	8d 76 00             	lea    0x0(%esi),%esi
        thread_yield();
    14a8:	e8 f3 fe ff ff       	call   13a0 <thread_yield>
    while(table[i].state != TS_ZOMBIE)
    14ad:	83 7e 04 03          	cmpl   $0x3,0x4(%esi)
    14b1:	75 f5                	jne    14a8 <thread_join+0x48>
    table[i].state = TS_FREE;
    14b3:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    return 0;
    14b9:	31 c0                	xor    %eax,%eax
    table[i].state = TS_FREE;
    14bb:	c7 83 24 1e 00 00 00 	movl   $0x0,0x1e24(%ebx)
    14c2:	00 00 00 
    14c5:	5b                   	pop    %ebx
    14c6:	5e                   	pop    %esi
    14c7:	5d                   	pop    %ebp
...
void mutex_lock(umutex_t *m)   { while (m->locked) thread_yield(); m->locked = 1; }
    ...
    14ea:	8b 03                	mov    (%ebx),%eax
    14ec:	85 c0                	test   %eax,%eax
    14ee:	74 0b                	je     14fb <mutex_lock+0x1b>
    14f0:	e8 ab fe ff ff       	call   13a0 <thread_yield>
    14f5:	8b 03                	mov    (%ebx),%eax
    14f7:	85 c0                	test   %eax,%eax
    14f9:	75 f5                	jne    14f0 <mutex_lock+0x10>
    14fb:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
    1501:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    1504:	c9                   	leave
    1505:	c3                   	ret
    1506:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    150d:	00 
    150e:	66 90                	xchg   %ax,%ax

00001510 <mutex_unlock>:
    1510:	55                   	push   %ebp
    1511:	89 e5                	mov    %esp,%ebp
    1513:	8b 45 08             	mov    0x8(%ebp),%eax
    1516:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    151c:	5d                   	pop    %ebp
    151d:	c3                   	ret
...
uswtch:
    ...
    movl  20(%esp), %eax
    1522:	8b 44 24 14          	mov    0x14(%esp),%eax
    movl  %esp, (%eax)
    1526:	89 20                	mov    %esp,(%eax)

    movl  24(%esp), %esp
    1528:	8b 64 24 18          	mov    0x18(%esp),%esp
