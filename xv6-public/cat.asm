 ...
 408:	89 d1                	mov    %edx,%ecx
{
 ...
 43b:	0f b6 92 0c 0b 00 00 	movzbl 0xb0c(%edx),%edx
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 514:	ff 24 85 b4 0a 00 00 	jmp    *0xab4(,%eax,4)
 ...
 620:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 625:	bb ac 0a 00 00       	mov    $0xaac,%ebx
...
free(void *ap)
{
 ...
 631:	a1 20 11 00 00       	mov    0x1120,%eax
{
 ...
 66f:	5b                   	pop    %ebx
  freep = p;
 670:	a3 20 11 00 00       	mov    %eax,0x1120
}
 675:	5e                   	pop    %esi
 676:	5f                   	pop    %edi
 677:	5d                   	pop    %ebp
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 20 11 00 00       	mov    %eax,0x1120
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 20 11 00 00    	mov    0x1120,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	3b 05 20 11 00 00    	cmp    0x1120,%eax
 ...
 72e:	e8 fd fe ff ff       	call   630 <free>
  return freep;
 733:	8b 15 20 11 00 00    	mov    0x1120,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 20 11 00 00    	mov    %edx,0x1120
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 20 11 00 00 24 	movl   $0x1124,0x1120
 777:	11 00 00 
    base.s.size = 0;
 77a:	b8 24 11 00 00       	mov    $0x1124,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 24 11 00 00 24 	movl   $0x1124,0x1124
 786:	11 00 00 
    base.s.size = 0;
 789:	c7 05 28 11 00 00 00 	movl   $0x0,0x1128
 790:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void)
{
 ...
 7b0:	a1 40 11 00 00       	mov    0x1140,%eax
        table[i].state = TS_FREE;
 7b5:	c7 05 70 21 00 00 00 	movl   $0x0,0x2170
 7bc:	00 00 00 
 7bf:	c7 05 7c 31 00 00 00 	movl   $0x0,0x317c
 7c6:	00 00 00 
    table[0].tid   = next_tid++;
 7c9:	8d 50 01             	lea    0x1(%eax),%edx
        table[i].state = TS_FREE;
 7cc:	c7 05 88 41 00 00 00 	movl   $0x0,0x4188
 7d3:	00 00 00 
 7d6:	c7 05 94 51 00 00 00 	movl   $0x0,0x5194
 7dd:	00 00 00 
 7e0:	c7 05 a0 61 00 00 00 	movl   $0x0,0x61a0
 7e7:	00 00 00 
 7ea:	c7 05 ac 71 00 00 00 	movl   $0x0,0x71ac
 7f1:	00 00 00 
 7f4:	c7 05 b8 81 00 00 00 	movl   $0x0,0x81b8
 7fb:	00 00 00 
    table[0].tid   = next_tid++;
 7fe:	89 15 40 11 00 00    	mov    %edx,0x1140
 804:	a3 60 11 00 00       	mov    %eax,0x1160
    table[0].state = TS_RUNNING;
 809:	c7 05 64 11 00 00 02 	movl   $0x2,0x1164
 810:	00 00 00 
    cur = 0;
 813:	c7 05 44 11 00 00 00 	movl   $0x0,0x1144
 81a:	00 00 00 
}
 81d:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg)
{
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 820:	ba 64 11 00 00       	mov    $0x1164,%edx
 ...
 834:	74 1a                	je     850 <thread_create+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 836:	83 c0 01             	add    $0x1,%eax
 839:	81 c2 0c 10 00 00    	add    $0x100c,%edx
 83f:	83 f8 08             	cmp    $0x8,%eax
 842:	75 ec                	jne    830 <thread_create+0x10>
 ...
 84a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
 ...
 851:	69 c0 0c 10 00 00    	imul   $0x100c,%eax,%eax
{
 857:	89 e5                	mov    %esp,%ebp
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 859:	8d 90 4c 21 00 00    	lea    0x214c(%eax),%edx
{
 85f:	53                   	push   %ebx
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 860:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 863:	89 90 68 11 00 00    	mov    %edx,0x1168(%eax)
    table[i].tid       = next_tid++;
 869:	8b 15 40 11 00 00    	mov    0x1140,%edx
    *(--sp) = 0xffffffff;        /* fake return address    */
 86f:	c7 80 60 21 00 00 ff 	movl   $0xffffffff,0x2160(%eax)
 876:	ff ff ff 
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 879:	89 88 68 21 00 00    	mov    %ecx,0x2168(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 87f:	8b 4d 08             	mov    0x8(%ebp),%ecx
    table[i].tid       = next_tid++;
 882:	8d 5a 01             	lea    0x1(%edx),%ebx
 885:	89 90 60 11 00 00    	mov    %edx,0x1160(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 88b:	89 88 64 21 00 00    	mov    %ecx,0x2164(%eax)
    *(--sp) = (uint)thread_stub; /* eip: ret jumps here    */
 891:	c7 80 5c 21 00 00 70 	movl   $0x970,0x215c(%eax)
 898:	09 00 00 
    *(--sp) = 0;                 /* ebp                    */
 89b:	c7 80 58 21 00 00 00 	movl   $0x0,0x2158(%eax)
 8a2:	00 00 00 
    *(--sp) = 0;                 /* ebx                    */
 8a5:	c7 80 54 21 00 00 00 	movl   $0x0,0x2154(%eax)
 8ac:	00 00 00 
    *(--sp) = 0;                 /* esi                    */
 8af:	c7 80 50 21 00 00 00 	movl   $0x0,0x2150(%eax)
 8b6:	00 00 00 
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 8b9:	c7 80 4c 21 00 00 00 	movl   $0x0,0x214c(%eax)
 8c0:	00 00 00 
    table[i].tid       = next_tid++;
 8c3:	89 1d 40 11 00 00    	mov    %ebx,0x1140
}
 8c9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    table[i].state     = TS_RUNNABLE;
 8cc:	c7 80 64 11 00 00 01 	movl   $0x1,0x1164(%eax)
 8d3:	00 00 00 
}
...
void thread_yield(void)
{
 ...
 8e6:	83 ec 0c             	sub    $0xc,%esp
    int old  = cur;
 8e9:	8b 1d 44 11 00 00    	mov    0x1144,%ebx
    for(i = 1; i <= MAX_THREADS; i++){
 8ef:	8d 53 01             	lea    0x1(%ebx),%edx
 8f2:	8d 73 09             	lea    0x9(%ebx),%esi
 8f5:	8d 76 00             	lea    0x0(%esi),%esi
        int idx = (cur + i) % MAX_THREADS;
 8f8:	89 d1                	mov    %edx,%ecx
 8fa:	c1 f9 1f             	sar    $0x1f,%ecx
 8fd:	c1 e9 1d             	shr    $0x1d,%ecx
 900:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
 903:	83 e0 07             	and    $0x7,%eax
 906:	29 c8                	sub    %ecx,%eax
        if(table[idx].state == TS_RUNNABLE)
 908:	69 c8 0c 10 00 00    	imul   $0x100c,%eax,%ecx
 90e:	83 b9 64 11 00 00 01 	cmpl   $0x1,0x1164(%ecx)
 915:	8d b9 60 11 00 00    	lea    0x1160(%ecx),%edi
 91b:	74 13                	je     930 <thread_yield+0x50>
    for(i = 1; i <= MAX_THREADS; i++){
 91d:	83 c2 01             	add    $0x1,%edx
 920:	39 f2                	cmp    %esi,%edx
 922:	75 d4                	jne    8f8 <thread_yield+0x18>
 ...
 933:	74 ef                	je     924 <thread_yield+0x44>
    table[old].state  = TS_RUNNABLE;
 935:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 93b:	83 ec 08             	sub    $0x8,%esp
    cur = next;
 93e:	a3 44 11 00 00       	mov    %eax,0x1144
    table[old].state  = TS_RUNNABLE;
 943:	c7 83 64 11 00 00 01 	movl   $0x1,0x1164(%ebx)
 94a:	00 00 00 
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 94d:	81 c3 68 11 00 00    	add    $0x1168,%ebx
    table[next].state = TS_RUNNING;
 953:	c7 47 04 02 00 00 00 	movl   $0x2,0x4(%edi)
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 95a:	ff 77 08             	push   0x8(%edi)
 95d:	53                   	push   %ebx
 95e:	e8 fb 00 00 00       	call   a5e <uswtch>
...
00000970 <thread_stub>:
{
 970:	55                   	push   %ebp
 971:	89 e5                	mov    %esp,%ebp
 973:	83 ec 14             	sub    $0x14,%esp
    fn(arg);
 976:	ff 75 0c             	push   0xc(%ebp)
 979:	ff 55 08             	call   *0x8(%ebp)
    table[cur].state = TS_ZOMBIE;
 97c:	69 05 44 11 00 00 0c 	imul   $0x100c,0x1144,%eax
 983:	10 00 00 
 986:	83 c4 10             	add    $0x10,%esp
 989:	c7 80 64 11 00 00 03 	movl   $0x3,0x1164(%eax)
 990:	00 00 00 
 993:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        thread_yield();
 998:	e8 43 ff ff ff       	call   8e0 <thread_yield>
    while(1)
 99d:	eb f9                	jmp    998 <thread_stub+0x28>
 99f:	90                   	nop

000009a0 <thread_join>:

int thread_join(tid_t tid)
{
 9a0:	55                   	push   %ebp
 9a1:	b8 60 11 00 00       	mov    $0x1160,%eax
 ...
 9ac:	53                   	push   %ebx
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 9ad:	31 db                	xor    %ebx,%ebx
 9af:	90                   	nop
        if(table[i].tid == tid) break;
 9b0:	39 10                	cmp    %edx,(%eax)
 9b2:	74 1c                	je     9d0 <thread_join+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 9b4:	83 c3 01             	add    $0x1,%ebx
 9b7:	05 0c 10 00 00       	add    $0x100c,%eax
 9bc:	83 fb 08             	cmp    $0x8,%ebx
 9bf:	75 ef                	jne    9b0 <thread_join+0x10>
 ...
 9c2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 9c7:	5e                   	pop    %esi
 9c8:	5d                   	pop    %ebp
 9c9:	c3                   	ret
 9ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(table[i].state != TS_ZOMBIE)
 9d0:	69 c3 0c 10 00 00    	imul   $0x100c,%ebx,%eax
 9d6:	83 b8 64 11 00 00 03 	cmpl   $0x3,0x1164(%eax)
 9dd:	8d b0 60 11 00 00    	lea    0x1160(%eax),%esi
 9e3:	74 0e                	je     9f3 <thread_join+0x53>
 9e5:	8d 76 00             	lea    0x0(%esi),%esi
        thread_yield();
 9e8:	e8 f3 fe ff ff       	call   8e0 <thread_yield>
    while(table[i].state != TS_ZOMBIE)
 9ed:	83 7e 04 03          	cmpl   $0x3,0x4(%esi)
 9f1:	75 f5                	jne    9e8 <thread_join+0x48>
    table[i].state = TS_FREE;
 9f3:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    return 0;
 9f9:	31 c0                	xor    %eax,%eax
    table[i].state = TS_FREE;
 9fb:	c7 83 64 11 00 00 00 	movl   $0x0,0x1164(%ebx)
 a02:	00 00 00 
 a05:	5b                   	pop    %ebx
 a06:	5e                   	pop    %esi
 a07:	5d                   	pop    %ebp
...
void mutex_lock(umutex_t *m)   { while (m->locked) thread_yield(); m->locked = 1; }
 ...
 a2e:	74 0b                	je     a3b <mutex_lock+0x1b>
 a30:	e8 ab fe ff ff       	call   8e0 <thread_yield>
 a35:	8b 03                	mov    (%ebx),%eax
 a37:	85 c0                	test   %eax,%eax
 a39:	75 f5                	jne    a30 <mutex_lock+0x10>
 a3b:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
 a41:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 a44:	c9                   	leave
 a45:	c3                   	ret
 a46:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
 a4d:	00 
 a4e:	66 90                	xchg   %ax,%ax

00000a50 <mutex_unlock>:
 a50:	55                   	push   %ebp
...
uswtch:
 ...
 a61:	57                   	push   %edi
    ...
    movl  20(%esp), %eax
 a62:	8b 44 24 14          	mov    0x14(%esp),%eax
    movl  %esp, (%eax)
 a66:	89 20                	mov    %esp,(%eax)

    movl  24(%esp), %esp
 a68:	8b 64 24 18          	mov    0x18(%esp),%esp
