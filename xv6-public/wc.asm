  ...
  aa:	31 db                	xor    %ebx,%ebx
{
  ...
  f0:	74 3e                	je     130 <wc+0x90>
      if(buf[i] == '\n')
  f2:	0f be 87 80 0f 00 00 	movsbl 0xf80(%edi),%eax
        l++;
 ...
 478:	89 d1                	mov    %edx,%ecx
{
 ...
 4ab:	0f b6 92 7c 0b 00 00 	movzbl 0xb7c(%edx),%edx
 ...
 519:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 584:	ff 24 85 24 0b 00 00 	jmp    *0xb24(,%eax,4)
 ...
 690:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 695:	bb 1b 0b 00 00       	mov    $0xb1b,%ebx
 ...
 6a1:	a1 80 11 00 00       	mov    0x1180,%eax
{
 ...
 6df:	5b                   	pop    %ebx
  freep = p;
 6e0:	a3 80 11 00 00       	mov    %eax,0x1180
}
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
 6e7:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 77b:	3b 05 80 11 00 00    	cmp    0x1180,%eax
 ...
 79e:	e8 fd fe ff ff       	call   6a0 <free>
  return freep;
 7a3:	8b 15 80 11 00 00    	mov    0x1180,%edx
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 80 11 00 00    	mov    %edx,0x1180
}
 ...
 7df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 80 11 00 00 84 	movl   $0x1184,0x1180
 7e7:	11 00 00 
    base.s.size = 0;
 7ea:	b8 84 11 00 00       	mov    $0x1184,%eax
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 84 11 00 00 84 	movl   $0x1184,0x1184
 7f6:	11 00 00 
    base.s.size = 0;
 7f9:	c7 05 88 11 00 00 00 	movl   $0x0,0x1188
 800:	00 00 00 
    if(p->s.size >= nunits){
...
void thread_init(void)
{
 ...
 820:	a1 a0 11 00 00       	mov    0x11a0,%eax
        table[i].state = TS_FREE;
 825:	c7 05 d0 21 00 00 00 	movl   $0x0,0x21d0
 82c:	00 00 00 
 82f:	c7 05 dc 31 00 00 00 	movl   $0x0,0x31dc
 836:	00 00 00 
    table[0].tid   = next_tid++;
 839:	8d 50 01             	lea    0x1(%eax),%edx
        table[i].state = TS_FREE;
 83c:	c7 05 e8 41 00 00 00 	movl   $0x0,0x41e8
 843:	00 00 00 
 846:	c7 05 f4 51 00 00 00 	movl   $0x0,0x51f4
 84d:	00 00 00 
 850:	c7 05 00 62 00 00 00 	movl   $0x0,0x6200
 857:	00 00 00 
 85a:	c7 05 0c 72 00 00 00 	movl   $0x0,0x720c
 861:	00 00 00 
 864:	c7 05 18 82 00 00 00 	movl   $0x0,0x8218
 86b:	00 00 00 
    table[0].tid   = next_tid++;
 86e:	89 15 a0 11 00 00    	mov    %edx,0x11a0
 874:	a3 c0 11 00 00       	mov    %eax,0x11c0
    table[0].state = TS_RUNNING;
 879:	c7 05 c4 11 00 00 02 	movl   $0x2,0x11c4
 880:	00 00 00 
    cur = 0;
 883:	c7 05 a4 11 00 00 00 	movl   $0x0,0x11a4
 88a:	00 00 00 
}
 88d:	c3                   	ret
...
tid_t thread_create(void (*fn)(void*), void *arg)
{
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 890:	ba c4 11 00 00       	mov    $0x11c4,%edx
 ...
 8a4:	74 1a                	je     8c0 <thread_create+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 8a6:	83 c0 01             	add    $0x1,%eax
 8a9:	81 c2 0c 10 00 00    	add    $0x100c,%edx
 8af:	83 f8 08             	cmp    $0x8,%eax
 8b2:	75 ec                	jne    8a0 <thread_create+0x10>
 ...
 8b4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 8b9:	c3                   	ret
 8ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
 8c0:	55                   	push   %ebp
    uint *sp = (uint*)(table[i].stack + STACK_SIZE);
 8c1:	69 c0 0c 10 00 00    	imul   $0x100c,%eax,%eax
{
 8c7:	89 e5                	mov    %esp,%ebp
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 8c9:	8d 90 ac 21 00 00    	lea    0x21ac(%eax),%edx
{
 8cf:	53                   	push   %ebx
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 8d0:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 8d3:	89 90 c8 11 00 00    	mov    %edx,0x11c8(%eax)
    table[i].tid       = next_tid++;
 8d9:	8b 15 a0 11 00 00    	mov    0x11a0,%edx
    *(--sp) = 0xffffffff;        /* fake return address    */
 8df:	c7 80 c0 21 00 00 ff 	movl   $0xffffffff,0x21c0(%eax)
 8e6:	ff ff ff 
    *(--sp) = (uint)arg;         /* arg for thread_stub    */
 8e9:	89 88 c8 21 00 00    	mov    %ecx,0x21c8(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 8ef:	8b 4d 08             	mov    0x8(%ebp),%ecx
    table[i].tid       = next_tid++;
 8f2:	8d 5a 01             	lea    0x1(%edx),%ebx
 8f5:	89 90 c0 11 00 00    	mov    %edx,0x11c0(%eax)
    *(--sp) = (uint)fn;          /* fn for thread_stub     */
 8fb:	89 88 c4 21 00 00    	mov    %ecx,0x21c4(%eax)
    *(--sp) = (uint)thread_stub; /* eip: ret jumps here    */
 901:	c7 80 bc 21 00 00 e0 	movl   $0x9e0,0x21bc(%eax)
 908:	09 00 00 
    *(--sp) = 0;                 /* ebp                    */
 90b:	c7 80 b8 21 00 00 00 	movl   $0x0,0x21b8(%eax)
 912:	00 00 00 
    *(--sp) = 0;                 /* ebx                    */
 915:	c7 80 b4 21 00 00 00 	movl   $0x0,0x21b4(%eax)
 91c:	00 00 00 
    *(--sp) = 0;                 /* esi                    */
 91f:	c7 80 b0 21 00 00 00 	movl   $0x0,0x21b0(%eax)
 926:	00 00 00 
    *(--sp) = 0;                 /* edi  <- saved_esp here */
 929:	c7 80 ac 21 00 00 00 	movl   $0x0,0x21ac(%eax)
 930:	00 00 00 
    table[i].tid       = next_tid++;
 933:	89 1d a0 11 00 00    	mov    %ebx,0x11a0
}
 939:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    table[i].state     = TS_RUNNABLE;
 93c:	c7 80 c4 11 00 00 01 	movl   $0x1,0x11c4(%eax)
 943:	00 00 00 
}
...
void thread_yield(void)
{
 ...
 956:	83 ec 0c             	sub    $0xc,%esp
    int old  = cur;
 959:	8b 1d a4 11 00 00    	mov    0x11a4,%ebx
    for(i = 1; i <= MAX_THREADS; i++){
 95f:	8d 53 01             	lea    0x1(%ebx),%edx
 962:	8d 73 09             	lea    0x9(%ebx),%esi
 965:	8d 76 00             	lea    0x0(%esi),%esi
        int idx = (cur + i) % MAX_THREADS;
 968:	89 d1                	mov    %edx,%ecx
 96a:	c1 f9 1f             	sar    $0x1f,%ecx
 96d:	c1 e9 1d             	shr    $0x1d,%ecx
 970:	8d 04 0a             	lea    (%edx,%ecx,1),%eax
 973:	83 e0 07             	and    $0x7,%eax
 976:	29 c8                	sub    %ecx,%eax
        if(table[idx].state == TS_RUNNABLE)
 978:	69 c8 0c 10 00 00    	imul   $0x100c,%eax,%ecx
 97e:	83 b9 c4 11 00 00 01 	cmpl   $0x1,0x11c4(%ecx)
 985:	8d b9 c0 11 00 00    	lea    0x11c0(%ecx),%edi
 98b:	74 13                	je     9a0 <thread_yield+0x50>
    for(i = 1; i <= MAX_THREADS; i++){
 98d:	83 c2 01             	add    $0x1,%edx
 990:	39 f2                	cmp    %esi,%edx
 992:	75 d4                	jne    968 <thread_yield+0x18>
 ...
 99c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(next == -1) return;
 9a0:	83 f8 ff             	cmp    $0xffffffff,%eax
 9a3:	74 ef                	je     994 <thread_yield+0x44>
    table[old].state  = TS_RUNNABLE;
 9a5:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 9ab:	83 ec 08             	sub    $0x8,%esp
    cur = next;
 9ae:	a3 a4 11 00 00       	mov    %eax,0x11a4
    table[old].state  = TS_RUNNABLE;
 9b3:	c7 83 c4 11 00 00 01 	movl   $0x1,0x11c4(%ebx)
 9ba:	00 00 00 
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 9bd:	81 c3 c8 11 00 00    	add    $0x11c8,%ebx
    table[next].state = TS_RUNNING;
 9c3:	c7 47 04 02 00 00 00 	movl   $0x2,0x4(%edi)
    uswtch(&table[old].saved_esp, table[next].saved_esp);
 9ca:	ff 77 08             	push   0x8(%edi)
 9cd:	53                   	push   %ebx
 9ce:	e8 fb 00 00 00       	call   ace <uswtch>
 9d3:	83 c4 10             	add    $0x10,%esp
}
 9d6:	8d 65 f4             	lea    -0xc(%ebp),%esp
 9d9:	5b                   	pop    %ebx
 9da:	5e                   	pop    %esi
 9db:	5f                   	pop    %edi
 9dc:	5d                   	pop    %ebp
...
000009e0 <thread_stub>:
{
 ...
 9ec:	69 05 a4 11 00 00 0c 	imul   $0x100c,0x11a4,%eax
 9f3:	10 00 00 
 9f6:	83 c4 10             	add    $0x10,%esp
 9f9:	c7 80 c4 11 00 00 03 	movl   $0x3,0x11c4(%eax)
 a00:	00 00 00 
 a03:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        thread_yield();
 a08:	e8 43 ff ff ff       	call   950 <thread_yield>
    while(1)
 a0d:	eb f9                	jmp    a08 <thread_stub+0x28>
 a0f:	90                   	nop
...
{
 a10:	55                   	push   %ebp
 a11:	b8 c0 11 00 00       	mov    $0x11c0,%eax
 ...
 a1c:	53                   	push   %ebx
    int i;
    for(i = 0; i < MAX_THREADS; i++)
 a1d:	31 db                	xor    %ebx,%ebx
 a1f:	90                   	nop
        if(table[i].tid == tid) break;
 a20:	39 10                	cmp    %edx,(%eax)
 a22:	74 1c                	je     a40 <thread_join+0x30>
    for(i = 0; i < MAX_THREADS; i++)
 a24:	83 c3 01             	add    $0x1,%ebx
 a27:	05 0c 10 00 00       	add    $0x100c,%eax
 a2c:	83 fb 08             	cmp    $0x8,%ebx
 a2f:	75 ef                	jne    a20 <thread_join+0x10>
 ...
 a3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(table[i].state != TS_ZOMBIE)
 a40:	69 c3 0c 10 00 00    	imul   $0x100c,%ebx,%eax
 a46:	83 b8 c4 11 00 00 03 	cmpl   $0x3,0x11c4(%eax)
 a4d:	8d b0 c0 11 00 00    	lea    0x11c0(%eax),%esi
 a53:	74 0e                	je     a63 <thread_join+0x53>
 a55:	8d 76 00             	lea    0x0(%esi),%esi
        thread_yield();
 a58:	e8 f3 fe ff ff       	call   950 <thread_yield>
    while(table[i].state != TS_ZOMBIE)
 a5d:	83 7e 04 03          	cmpl   $0x3,0x4(%esi)
 a61:	75 f5                	jne    a58 <thread_join+0x48>
    table[i].state = TS_FREE;
 a63:	69 db 0c 10 00 00    	imul   $0x100c,%ebx,%ebx
    return 0;
 a69:	31 c0                	xor    %eax,%eax
    table[i].state = TS_FREE;
 a6b:	c7 83 c4 11 00 00 00 	movl   $0x0,0x11c4(%ebx)
 a72:	00 00 00 
 a75:	5b                   	pop    %ebx
 a76:	5e                   	pop    %esi
 a77:	5d                   	pop    %ebp
...
void mutex_lock(umutex_t *m)   { while (m->locked) thread_yield(); m->locked = 1; }
 ...
 a9e:	74 0b                	je     aab <mutex_lock+0x1b>
 aa0:	e8 ab fe ff ff       	call   950 <thread_yield>
 aa5:	8b 03                	mov    (%ebx),%eax
 aa7:	85 c0                	test   %eax,%eax
 aa9:	75 f5                	jne    aa0 <mutex_lock+0x10>
 aab:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
...
uswtch:
 ...
 ad1:	57                   	push   %edi
    ...
    movl  20(%esp), %eax
 ad2:	8b 44 24 14          	mov    0x14(%esp),%eax
    movl  %esp, (%eax)
 ad6:	89 20                	mov    %esp,(%eax)

    movl  24(%esp), %esp
 ad8:	8b 64 24 18          	mov    0x18(%esp),%esp
